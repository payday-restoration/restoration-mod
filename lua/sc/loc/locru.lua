...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_a_dragons_breath_auto_desc_sc"] = "Дробинки обладают #{skill_color}#50%## шансом #{heat_warm_color}#поджечь врагов##, прерывая и нанося #{heat_warm_color}#96## урона в течение #{skill_color}#3## секунд.",
		["bm_wp_upg_a_dragons_breath_semi_desc_sc"] = "Дробинки обладают #{skill_color}#50%## шансом #{heat_warm_color}#поджечь врагов##, прерывая и нанося #{heat_warm_color}#120## урона в течение #{skill_color}#3## секунд.",
		["bm_wp_upg_a_dragons_breath_pump_desc_sc"] = "Дробинки обладают #{skill_color}#50%## шансом #{heat_warm_color}#поджечь врагов##, прерывая и нанося #{heat_warm_color}#180## урона в течение #{skill_color}#3## секунд.",
		["bm_wp_upg_a_dragons_breath_heavy_desc_sc"] = "Дробинки обладают #{skill_color}#50%## шансом #{heat_warm_color}#поджечь врагов##, прерывая и нанося #{heat_warm_color}#240## урона в течение #{skill_color}#3## секунд.",
		["bm_wp_upg_a_rip"] = "Дробь 'Томбстоун'",
		["bm_wp_upg_a_rip_auto_desc_sc"] = "#{stats_positive}#Ядовитая## дробь, которая может оглушить врагов и наносит #{stats_positive}#30## урона ядом в течение #{skill_color}#1## секунды.",
		["bm_wp_upg_a_rip_semi_desc_sc"] = "#{stats_positive}#Ядовитая## дробь, которая может оглушить врагов и наносит #{stats_positive}#60## урона ядом в течение #{skill_color}#2## секунд.",
		["bm_wp_upg_a_rip_pump_desc_sc"] = "#{stats_positive}#Ядовитая## дробь, которая может оглушить врагов и наносит #{stats_positive}#90## урона ядом в течение #{skill_color}#3## секунды.",
		["bm_wp_upg_a_rip_heavy_desc_sc"] = "#{stats_positive}#Ядовитая## дробь, которая может оглушить врагов и наносит #{stats_positive}#120## урона ядом в течение #{skill_color}#4## секунды.",
		["bm_wp_upg_a_piercing_auto_desc_sc"] = "Флешетты #{skill_color}#пробивают броню## и наносят #{skill_color}#96## урона кровотечением в течение #{skill_color}#8## секунд.",
		["bm_wp_upg_a_piercing_auto_desc_sc"] = "Флешетты #{skill_color}#пробивают броню## и наносят #{skill_color}#120## урона кровотечением в течение #{skill_color}#8## секунд.",
		["bm_wp_upg_a_piercing_auto_desc_sc"] = "Флешетты #{skill_color}#пробивают броню## и наносят #{skill_color}#180## урона кровотечением в течение #{skill_color}#8## секунд.",
		["bm_wp_upg_a_piercing_auto_desc_sc"] = "Флешетты #{skill_color}#пробивают броню## и наносят #{skill_color}#240## урона кровотечением в течение #{skill_color}#8## секунд.",
		...
		["bm_w_sparrow_sc_g_cowboy_desc"] = "Ты что, ковбой?",
		--socom deez nuts--
        ...
        ["bm_w_x_chinchilla"] = "Парные Кастиго .44s",		
		...
		--CUSTOM SMGs
			...
			["bm_w_smg45_desc"] = "Американский клон АМП 45.",
			--Typhoon
		...
		["bm_hk51b_sc_desc"] = "Подпольная модификация Бреннера, которая уменьшает его до размеров Compact-5.\n\nТеряет точность при стрельбе от бедра.",	
		--M134
		...
		["bm_wp_shak12_body_vks_ap_desc"] = "Предоставляет ещё более мощный калибр, который позволяет #{skill_color}#пробивать броню и щиты.## Приклад и затвор укреплены тяжёлым материалом, что #{important_1}#уменьшает скорострельность.##",	
			...
			["bm_g3hk79_sc_desc_pc"] = "Вариация Гевер 3 с #{skill_color}#подствольным гранатомётом.##\n\nНажмите #{skill_color}#$BTN_BIPOD## чтобы переключиться на гранатомёт.",	
			--BO3 XR2
			["bm_w_xr2"] = "Иксэр 2",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck9_3_desc_sc"] = "Убийство врага восстанавливает ##20## брони.\n\nЭто может происходить только раз в ##5## секунд, но каждое убийство сокращает время на ##0.5## секунд, а убийство холодным оружием - на ##1## секунду.\n\nВы получаете ##5## уворота.",
