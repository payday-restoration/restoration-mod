...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_a_custom_desc"] = " #{important_1}#6## больших дробинок #{skill_color}#имеют увеличенный урон и наносят 20% урона через броню## за счёт #{important_1}#количества дробинок, эффективного расстояния, подбора и боезапаса.##",
		...
		["bm_wp_upg_a_dragons_breath_semi_desc_sc"] = "Магниевые осколки обладают #{skill_color}#20%## шансом #{heat_warm_color}#поджечь врагов##, прерывая и нанося #{heat_warm_color}#120## урона в течение #{skill_color}#3## секунд.\n\n#{risk}#Шанс уменьшается с расстоянием и становится нулевым за пределом минимальной дальности.##",
		["bm_wp_upg_a_dragons_breath_pump_desc_sc"] = "Магниевые осколки обладают #{skill_color}#30%## шансом #{heat_warm_color}#поджечь врагов##, прерывая и нанося #{heat_warm_color}#180## урона в течение #{skill_color}#3## секунд.\n\n#{risk}#Шанс уменьшается с расстоянием и становится нулевым за пределом минимальной дальности.##",
		["bm_wp_upg_a_dragons_breath_heavy_desc_sc"] = "Магниевые осколки обладают #{skill_color}#40%## шансом #{heat_warm_color}#поджечь врагов##, прерывая и нанося #{heat_warm_color}#240## урона в течение #{skill_color}#3## секунд.\n\n#{risk}#Шанс уменьшается с расстоянием и становится нулевым за пределом минимальной дальности.##",
		...
		["bm_wp_upg_a_rip_semi_desc_sc"] = "#{stats_positive}#Ядовитая## дробь, которая может оглушить врагов. Наносит #{stats_positive}#60## урона ядом в течение #{skill_color}#2## секунд.",
		["bm_wp_upg_a_rip_pump_desc_sc"] = "#{stats_positive}#Ядовитая## дробь, которая может оглушить врагов. Наносит #{stats_positive}#90## урона ядом в течение #{skill_color}#3## секунды.",
		["bm_wp_upg_a_rip_heavy_desc_sc"] = "#{stats_positive}#Ядовитая## дробь, которая может оглушить врагов. Наносит #{stats_positive}#120## урона ядом в течение #{skill_color}#4## секунды.",
		...
		--CUSTOM ARs
			...
			["bm_w_rk62"] = "Вельмер",
			--NV4
			["bm_nova4_sc_desc"] = "Полностью автоматический баллистическая винтовка. Восхитительная точность за счёт уменьшенной скорострельности. Идеальна для перестрелок на средних и дальних дистанциях.",
		...
		["bm_wp_shak12_body_vks_ap_desc"] = "Предоставляет ещё более мощный калибр, который позволяет #{skill_color}#пробивать броню и щиты.## Приклад и затвор укреплены тяжёлым материалом, что #{important_1}#уменьшает скорострельность.##",	
			...
			["bm_g3hk79_sc_desc_pc"] = "Вариация Гевер 3 с #{skill_color}#подствольным гранатомётом.## #{skill_color}#Наносит 80% урона через броню и может пробивать врагов и тонкие стены.##\n\nНажмите #{skill_color}#$BTN_BIPOD## чтобы переключиться на гранатомёт.",	
			--BO3 XR2
			["bm_w_xr2"] = "Иксэр 2",
	...
	if weapon_names then
		if weapon_names == 3 then
			LocalizationManager:add_localized_strings({	
				...
				["bm_wp_hs2000_m_extended"] = "Магазин XD(M)-40 на 22 патрона",
				["bm_wp_hs2000_sl_custom"] = "Сбалансированный затвор",
				["bm_wp_hs2000_sl_long"] = "Самодельный затвор",
				--Signature 40
				["bm_w_p226"] = "SIG P226R",
				["bm_w_x_p226"] = "Akimbo P226Rs",
				["bm_wp_p226_co_comp_2"] = "Насадка SJC .40",
				["bm_wp_p226_m_extended"] = "Магазин P226 на 22 патрона",
				["bm_wp_p226_b_equinox"] = "Затвор Equinox Duo-Tone",
				["bm_wp_p226_b_long"] = "Затвор Brushed Long",

				--Crosskill
				["bm_w_colt_1911"] = "SA 1911 Operator",
				["bm_w_x_colt_1911"] = "Парные 1911 Operator",
				["bm_wp_1911_co_2"] = "Насадка TCII", --Not 100% but seems to be based off of it
				["bm_wp_1911_co_1"] = "Clark Heavy Pinmaster", --Not 100% but seems to be based off of it
				["bm_wp_1911_g_ergo"] = "Рукоятка Pachmayr 1911",
				["bm_wp_1911_g_bling"] = "Рукоятка Walnut",
				["bm_wp_1911_g_engraved"] = "Самодельная рукоятка 1911",
				["bm_wp_1911_b_long"] = "Длинный сбалансированный затвор",
				["bm_wp_1911_b_vented"] = "Сбалансированный двухтональный затвор",
				["bm_wp_1911_m_extended"] = "Магазин на 12 патронов",
				--Crosskill Chunky
				["bm_w_m1911"] = "Colt 1911A1",
				["bm_w_x_m1911"] = "Парные 1911A1",
			})
		end
	end	
