...
Hooks:PostHook( LevelsTweakData, "init", "SC_levels", function(self)
	...
	--self.crojob3.package = {"packages/dlcs/the_bomb/crojob_stage_3", "packages/americamisc", "packages/omniamisc"} --uncomment this once I'm done with implementing scripted spawns

	self.crojob3_night.ai_group_type = russia				
	self.crojob3_night.player_style = "loud_suit"		
	self.crojob3_night.flashlights_on = true
	--self.crojob3_night.package = {"packages/dlcs/the_bomb/crojob_stage_3_night", "packages/americamisc", "packages/omniamisc"} --uncomment this once I'm done with implementing scripted spawns
