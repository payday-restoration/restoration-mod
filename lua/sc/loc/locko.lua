...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_xeno_sc_desc_pc"] = "\"Armat\"에서 이 이상한 우주 시대적 기술로 제작된 소총.\n\n특수 제작된 10mm 탄약통은 폭발성이 없지만 여전히 방탄복을 뚫을 수 있습니다.\n$BTN_BIPOD 키를 눌러 통합 30mm 유탄 발사기로 전환합니다.",	
		["bm_xeno_sc_desc"] = "\"Armat\"에서 이 이상한 우주 시대적 기술로 제작된 소총.\n\n특수 제작된 10mm 탄약통은 폭발성이 없지만 여전히 방탄복을 뚫을 수 있습니다.\n$BTN_BIPOD 키를 꾹 눌러 통합 30mm 유탄 발사기로 전환합니다.",		
