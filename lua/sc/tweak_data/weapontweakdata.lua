...
Hooks:PostHook( WeaponTweakData, "init", "SC_weapons", function(self)
	...
	--[[     LIGHT SNIPERS     ]]	
		...
		--PRIMARIES
			...
			--Kang Arms X1 (QBU-88)
				...
				self.qbu88.fire_mode_data.fire_rate = 0.276923
				self.qbu88.fire_rate_multiplier = 1.2
				self.qbu88.sms = 0.7
			...
			--Contractor .308
				...
				self.tti.fire_mode_data.fire_rate = 0.28571
				self.tti.sms = 0.7
	...
	--[[     HEAVY SNIPERS     ]]
		...
		--Lebensauger .308
			...
			self.wa2000.fire_mode_data.fire_rate = 0.42857
			self.wa2000.sms = 0.7
	...
	--[[     ANTI-MATERIEL SNIPERS     ]]
		...
		--Thanatos .50 cal
			...
			self.m95.fire_rate_multiplier = 1.375
	...
	if self.sgs then --Gambyt's Guerilla 308.	
		...
		self.sgs.fire_mode_data.fire_rate = 0.3
	...
	if self.minibeck then --Reinbeck Auto
		...
		self.minibeck.muzzleflash = "effects/particles/shotgun/muzzleflash"
	...
	if self.qrl then
		...
		self.qrl.timers.reload_exit_empty = 3.1
		self.qrl.timers.reload_exit_not_empty = 3.1
