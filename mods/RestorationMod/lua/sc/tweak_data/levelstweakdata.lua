if SC and SC._data.sc_ai_toggle or restoration and restoration.Options:GetValue("SC/SC") then
	...
	Hooks:PostHook( LevelsTweakData, "init", "SC_levels", function(self)
		...
		self.man.package = {"packages/narr_pal", "levels/narratives/elephant/mad/world_sounds"}
		self.firestarter_3.package = {"packages/narr_mia_2", "levels/narratives/elephant/mad/world_sounds"}
		self.jolly.package = {"packages/narr_firestarter3", "levels/narratives/elephant/mad/world_sounds"}
		self.rvd1.package = {"packages/jolly", "levels/narratives/elephant/mad/world_sounds"}
	end)
