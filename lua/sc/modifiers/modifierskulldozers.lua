...
function ModifierSkulldozers:init(data)
	...
	if difficulty_index <= 7 then 
		...
		table.insert(unit_types.fbi, Idstring("units/pd2_mod_fbi/characters/ene_bulldozer_3/ene_bulldozer_3"))
		...
		table.insert(unit_types_black.fbi, Idstring("units/pd2_mod_fbi/characters/ene_bulldozer_3/ene_bulldozer_3"))	
	else	
