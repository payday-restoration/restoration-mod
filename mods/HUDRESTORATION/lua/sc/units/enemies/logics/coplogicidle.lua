...
function CopLogicIdle.enter(data, new_logic_name, enter_params)
	...
	local fuck_range_garbage = tweak_data.character[data.unit:base()._tweak_table]
	if fuck_range_garbage.weapon then
			local fuck_you_and_your_tables = fuck_range_garbage.weapon[usage]
