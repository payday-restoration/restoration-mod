...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_a_explosive_desc_sc"] = "高爆弹。射出一发能使人眩晕的爆炸半径为#{skill_color}#1.5米##的致命性爆炸弹头，不能触发爆头。",
		...
		["bm_ap_armor_80_weapon_sc_desc"] = "可#{skill_color}#穿透护甲##造成80%伤害并可#{skill_color}#穿透敌人和薄墙壁##。",
...
--[[   SKILLTREES   ]]--
	...
	--}
		...
		["menu_wolverine_beta_desc_sc"] = "掌握: ##$basic##\n你的血量越少，你的血量减伤分数越高。\n\n你的血量低于##100%##时，你受到的对##血量##的伤害最多减少##20%##。\n\n对血量的减伤会在其他减伤计算完后再进行计算。\n\n专精: ##$pro##\n你的血量越少，你的血量减伤分数越高。\n\n你的血量低于##100%##时，你受到的对##血量##的伤害现在最多减少##50%##。",																																																																																																																																																																																																																																		
