...
function ModifierSkulldozers:init(data)
	...
	if difficulty_index <= 7 then 
		...
		table.insert(unit_types.fbi, Idstring("units/payday2/characters/ene_bulldozer_3_sc/ene_bulldozer_3_sc"))
		table.insert(unit_types.omnia, Idstring("units/pd2_mod_omnia/characters/ene_bulldozer_3/ene_bulldozer_3"))
		...
		table.insert(unit_types_black.fbi, Idstring("units/payday2/characters/ene_bulldozer_3_sc/ene_bulldozer_3_sc"))	
		table.insert(unit_types_black.omnia, Idstring("units/pd2_mod_omnia/characters/ene_bulldozer_3/ene_bulldozer_3"))
	else	
