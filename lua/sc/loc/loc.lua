...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck4_9_desc_sc"] = "Dodging an attack causes you to regenerate ##1## life point every ##2## seconds for the next ##30## seconds. This effect can stack, but all stacks are lost whenever you take health damage.\n\nDeck completion Bonus: Your chance of getting a higher quality item during PAYDAY is increased by ##10%.##",
		...
		["menu_deck12_3_desc_sc"] = "The lower your health the more the dodge meter is filled when you kill an enemy. When your health is below ##50%##, your meter fills by up to ##50%## of your dodge.\n\nYour dodge is increased by ##5## points.",
		...
		["menu_deck12_7_desc_sc"] = "The lower your health the more the dodge meter is filled when you kill an enemy in melee. When your health is below ##50%##, your meter fills by up to an additional ##50%## of your dodge.\n\nYour dodge is increased by an additional ##5## points.",
