...
IncendiaryBulletBase = BleedBulletBase or class(DOTBulletBase)
IncendiaryBulletBase.VARIANT = "fire_bullet"

function IncendiaryBulletBase:start_dot_damage(col_ray, weapon_unit, dot_data, weapon_id, user_unit, defense_data)
	local target_unit = col_ray.unit
