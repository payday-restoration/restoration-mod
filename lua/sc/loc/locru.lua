...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--1911 
		["bm_1911_sc_desc"] = "Когда 9мм кажется мало, возьмите этот модифицированный 1911А1, заряженный мощными .45ACP. Полная жестокость.",
		...
		--Versteckt-51/HK51B
		["bm_w_hk51b"] = "Крупнокалиберный пулемёт Versteckt-51B",
		...
		--Galant--
		["bm_galant_sc_desc"] = "Классическая винтовка времён Второй мировой. Надёжная, точная #{skill_color}#быстро перезаряжается при опустошении.\n\nНаносит 80% урона через броню и может пробивать врагов и тонкие стены.##",
		--M308
