...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_o_1_1_health"] = "Отражательный прицел, который показывает здоровье противников при наведении.\n#{risk}#Увеличение 1.1x.##",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck23_1_short"] = "Ваше оружие перезарядится само после убийства ##10## врагов этим оружием.\n\nВы переключаете оружие на ##15%## быстрее.",
		["menu_deck23_1_1_desc"] = "Ваше здоровье увеличено на ##7.5%##.",
		["menu_deck23_1_1_short"] = "Ваше здоровье увеличено на ##7.5%##.",
		["menu_deck23_1_2_desc"] = "Ваша броня увеличена на ##5%##.",
		["menu_deck23_1_2_short"] = "Ваша броня увеличена на ##5%##.",
		...
		["menu_deck23_3_1_desc"] = "Ваше здоровье увеличено на ##7.5%##.",
		["menu_deck23_3_1_short"] = "Ваше здоровье увеличено на ##7.5%##.",
		["menu_deck23_3_2_desc"] = "Ваша броня увеличена на ##5%##.",
		["menu_deck23_3_2_short"] = "Ваша броня увеличена на ##5%##.",
		...
		["menu_deck23_5_desc"] = "Пули, от которых вы увернулись, отлетят во врагов.\n\nПули, которые ломают вашу броню, отлетят обратно во врага и нанесут на ##50%## больше урона.\n\nРикошеты от брони происходят не чаще чем раз в ##10## секунд.",
		["menu_deck23_5_short"] = "Пули, от которых вы увернулись, отлетят во врагов.\n\nПули, которые ломают вашу броню, отлетят обратно во врага и нанесут на ##50%## больше урона.\n\nРикошеты от брони происходят не чаще чем раз в ##10## секунд.",
		["menu_deck23_5_1_desc"] = "Ваше здоровье увеличено на ##7.5%##.",
		["menu_deck23_5_1_short"] = "Ваше здоровье увеличено на ##7.5%##.",
	    ["menu_deck23_5_2_desc"] = "Ваша броня увеличена на ##5%##.",
		["menu_deck23_5_2_short"] = "Ваша броня увеличена на ##5%##.",
		...
		["menu_deck23_7_short"] = "Когда ваше здоровье опускается ниже ##25%##, вы получите иммунитет к урону на ##2## секунды.\n\nЭто может произойти не чаще чем раз в ##30## секунд.",
		["menu_deck23_7_1_desc"] = "Ваше здоровье увеличено на ##7.5%##.",
		["menu_deck23_7_1_short"] = "Ваше здоровье увеличено на ##7.5%##.",
		["menu_deck23_7_2_desc"] = "Ваша броня увеличена на ##5%##.",
		["menu_deck23_7_2_short"] = "Ваша броня увеличена на ##5%##.",
		...
		--Final Card
			...
			--Sociopath
			["menu_deck9_mrwi_desc"] = "Убийство врага восстанавливает ##20## брони.\n\nЭффект активируется вместе с предыдущим перком раз в ##5## секунд, но каждое убийство сокращает время на ##0.5## секунд, а убийство холодным оружием - на ##1.5## секунды.\n\nСокращение так же действует на Карту 3.\n\nВы носите на ##1## мешок для тел больше.",
			--Gambler
