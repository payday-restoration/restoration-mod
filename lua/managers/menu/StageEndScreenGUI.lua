...
function StageEndScreenGui:feed_statistics(data)
	...
	data.last_completed_challenge = (managers.challenges_res and managers.challenges_res:get_last_comleted_title_text() or managers.localization:text("RestorationPDTHHudNeeded") )
	self._data = data or {}
