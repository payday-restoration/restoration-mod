...
function GuiTweakData:init()
    ...
    self.part_texture_switches = {
        ...
        wpn_fps_upg_o_eotech_xps = "1 " .. tostring(#self.weapon_texture_switches.types.sight_swap - 4),
        wpn_fps_upg_o_uh = "1 " .. tostring(#self.weapon_texture_switches.types.sight_swap - 1)
    }
end