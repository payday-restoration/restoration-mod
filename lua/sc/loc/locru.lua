...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["RestorationModPerPelletShotgunsDescID"] = "Урон от дробовика рассчитывается за каждую дробинку в отличие от стандартного \"1 дробинка = полный урон, приоритет отдается выстрелам в голову\". Урон от дробовика, не наносимый пулями, увеличен, чтобы компенсировать меньшую согласованность. Требуется перезагрузка.",
