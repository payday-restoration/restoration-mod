...
function MutatorMedicdozers:setup(data)
	...
	if difficulty_index <= 7 then 
		...
		table.insert(unit_types.sfpd, classic_medic_unit_name)
		...
		table.insert(unit_types_black.sfpd, classic_medic_unit_name)
		...
		table.insert(unit_types_skull.sfpd, classic_medic_unit_name)
	else
		...
		table.insert(unit_types.sfpd, medic_unit_name)
		...
		table.insert(unit_types_black.sfpd, medic_unit_name)
		...
		table.insert(unit_types_skull.sfpd, medic_unit_name)
	end		
end