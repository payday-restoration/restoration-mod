...
local tank_skull = (difficulty == 8 and pro_job) ("units/pd2_mod_omnia/characters/ene_bulldozer_3/ene_bulldozer_3") or ("units/pd2_mod_sharks/characters/ene_murky_fbi_tank_m249/ene_murky_fbi_tank_m24")
