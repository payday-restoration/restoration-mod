...
function PlayerDamage:init(unit)
	...
	self._deflection = math.min(1 - player_manager:body_armor_value("deflection", nil, 0) - player_manager:get_deflection_from_skills(), 0.05) --Damage reduction for health. Crashes here mean there is a syntax error in playermanager.
...
function PlayerDamage:_bleed_out_damage(attack_data)
	...
	local deflection = math.min(self._deflection - (managers.player:upgrade_value("player", "frenzy_deflection", 0) * (1 - self:health_ratio())), 0.05)
...
function PlayerDamage:_calc_health_damage(attack_data)
	...
	if self:has_temp_health() then --Hitman deflection bonus.
		deflection = math.min(deflection - managers.player:upgrade_value("player", "temp_health_deflection", 0), 0.05)
	end
