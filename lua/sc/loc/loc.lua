...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["RestorationModWeaponHandlingOptionsButtonTitleID"] = "+++ Weapon Handling Toggles +++",
		["RestorationModWeaponHandlingOptionsButtonDescID"] = "Options regarding weapon handling.",
		...
		["RestorationModQueuedShootingWindowTitleID"] = "Queued Shooting Sensitivity",
		...
		["RestorationModQueuedShootingExcludeTitleID"] = "Queued Shooting Fire Rate Limit",
		["RestorationModQueuedShootingExcludeDescID"] = "Limits queued shooting to weapons that fire above the firerate (RPM) set by this option.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--Ordanance Bag
		["bm_equipment_grenade_crate_desc"] = "To use the Ordanace Bag, you need to place it by holding #{skill_color}#$BTN_USE_ITEM.## Once placed it cannot be moved, but it can be used by you and your crew by holding #{skill_color}#$BTN_INTERACT## to refill your throwables.\n\nIt can only be used #{skill_color}#3## times; you can see how many uses are left by looking at the bag.\n\nThe Ordnance Bag is a portable bag carried by combat operatives to transport explosives and other throwable weapons into a battle zone.\n\n#{important_1}#NOTE: CANNOT BE USED TO RESTORE REGENERATING OR COOLDOWN-BASED THROWABLES.##",
		["bm_equipment_grenade_crate_desc_short"] = "To use the Ordanace Bag, you need to place it by holding #{skill_color}#$BTN_USE_ITEM.## Once placed it cannot be moved, but it can be used by you and your crew by holding #{skill_color}#$BTN_INTERACT## to refill your throwables.\n\nIt can only be used #{skill_color}#3## times; you can see how many uses are left by looking at the bag.\n\n#{important_1}#NOTE: CANNOT BE USED TO RESTORE REGENERATING OR COOLDOWN-BASED THROWABLES.##",
		--Trip Mine
