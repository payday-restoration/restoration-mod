Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_a_explosive_desc_sc"] = "Взрывные пули, которые убивают или оглушают врагов. Не имеет попаданий в голову.",
		...
		["bm_wp_upg_a_piercing_desc"] = "Высокая дальнобойность и более кучный разброс.",
		["bm_wp_upg_a_dragons_breath_desc_sc"] = "Зажигательные дробинки. Огонь наносит постепенный урон, имеет шанс прервать врагов и пробивает броню.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["loading_gameplay_res_3"] = "На Смертном приговоре, противники могут броситься в атаку, если вы начнёте перезаряжаться. Убедитесь, что вы в укрытии или далеко от врагов. В некоторых случаях лучше переключиться на второстепенное оружие, особенно если это пистолет.",
		...
		["loading_gameplay_res_11"] = "Все Дозеры, кроме Титановых Дозеров, пойдут в атаку на игрока, который перезаряжается.",
		...
		["loading_stealth_res_5"] = "Стрельба без глушителя не встревожит всю карту. У вас и ваших врагов существуют различные расстояния шума в зависимости от оружия и его модификаций. Соответственно, не все глушители бесшумны, и могут встревожить ближайших врагов, если характеристика Шума достаточно высока.",
		["loading_stealth_res_6"] = "Гражданские падают на землю, когда слышат стрельбу как при громком прохождении, так и стелсе. Оружие без глушителя можно использовать на некоторых стелс-ограблениях, чтобы контролировать гражданских.",	
		...
		["loading_stealth_res_18"] = "Охранники, которые успели активировать пейджер, увеличивают шкалу подозрения сильнее, чем те, которые погибли и не успели, даже если вы ещё не достигли лимита пейджеров.",
		["loading_stealth_res_19"] = "Лимит пейджеров сильно сокращён по сравнению с ванильной игрой. На 'Смертном приговоре', у вас будет только один. Использование последнего пейджера обозначается особой фразой от оператора.",
		...
		["loading_equip_skills_res_19"] = "Если справа на экране есть шкала синего цвета - вы набрали Уворот (Dodge). Когда он подсвечивается, вы увернётесь от следующей пули. Для более подробного объяснения механики уворота, используйте Гайд.",	
		...
		["loading_equip_skills_res_22"] = "Нож-бабочка и Выкидной нож наносят дополнительный урон сзади. Нож-бабочка практически бесполезен при атаке спереди, но смертелен при атаках сзади, в то время как Выкидной нож - это более усреднённое оружие.",		
		["loading_equip_skills_res_23"] = "Ледоруб и Золотая лихорадка наносят дополнительный урон в голову, но низкий в тело.",
		...
		["loading_equip_skills_res_27"] = "Гвоздомёт - оружие ближнего боя с очень высокой дальнобойностью, что делает его полезным против Клокеров и лёгких спецназовцев, а также для 'дальнего ближнебойного' убийства в стелсе, если у вас получится компенсировать его низкую Скрытность.",	
		...
		["loading_equip_skills_res_30"] = "Пиковый навык Вдохновление (Inspire Ace) теперь очень долго перезаряжается  и требует прямой видимости. Используйте его только когда находитесь в действительно плохой ситуации.",	
		...
		["menu_cs_modifier_heavy_sniper"] = "Все тяжёлые SWAT получают дополнительный 15% шанс стать Титаном с дробовиком.",
		["menu_cs_modifier_dozer_medic"] = "Все Агенты-ветераны получают дополнительный 15% шанс стать Копом-ветераном.",
		["menu_cs_modifier_dozer_minigun"] = "Все Бульдозеры имеют дополнительный 15% шанс стать Титановыми Бульдозерами.",
		["menu_cs_modifier_shield_phalanx"] = "Все обычные Щиты получают дополнительный 15% шанс стать Титановыми щитами.",
		["menu_cs_modifier_concealment"] = "Подозрение копится на 10% быстрее.",
		["menu_cs_modifier_cloaker_smoke"] = "Клокеры сбрасывают дымовыую завесу, когда ударяют игрока.",
		["menu_cs_modifier_taser_overcharge"] = "Все Тазеры получают дополнительный 15% шанс стать Титановыми Тазерами.",
		["menu_cs_modifier_dozer_rage"] = "Когда стекло Бульдозера уничтожено, он войдёт в ярость, получая 10% к сопротивлению урона.",
		["menu_cs_modifier_medic_adrenaline"] = "Все Медики получают дополнительный 15% шанс стать OMNIA LPF.",
		["menu_cs_modifier_cloaker_arrest"] = "Удачные удары ногой в воздухе от Клокеров теперь приводят к падению, а не заковывают в наручники.",
		["menu_cs_modifier_cloaker_smoke"] = "Все Клокеры получают дополнительный 15% шанс стать Титановыми Клокерами.",
		...
		["menu_cs_modifier_dozer_lmg"] = "Когда появляется Зелёный Бульдозер, есть шанс, что он будет заменён на Бульдозера с М1014; Когда появляется Чёрный Бульдозер, есть шанс, что он будет заменён на Бульдозера-медика.",
		["menu_cs_modifier_pagers"] = "Ответ на пейджер занимает на 1 секунду больше.",
        ...
        ["menu_crew_sturdy_desc"] = "Броня игроков увеличена на 15.",
        ...
        ["menu_crew_motivated_desc"] = "Игроки получают на 25 больше стамины.",

        ["menu_crew_regen"] = "Лекарь",
        ["menu_crew_regen_desc"] = "Игроки лечат 1 здоровья каждые 4 секунды.",

        ["menu_crew_quiet"] = "Скрытый",
        ["menu_crew_quiet_desc"] = "Игроки получают 1 больше скрытности.",
...
--[[   SKILLTREES   ]]--
	--{
		...
		--{
			...
			["menu_tea_time_beta_desc_sc"] = "БАЗОВЫЙ: ##$basic##\nУвеличивает скорость для установки аптечек первой помощи и медицинских сумок на ##50%.##\n\nПИКОВЫЙ: ##$pro##\nCЧлены команды, которые воспользовались вашими аптечками первой помощи, будут получать на  ##50%## меньше урона в течение ##5## секунд.",
			...
			--Uppers
			["menu_tea_cookies_beta_sc"] = "Колёса",
			...
			--MG Handling
			["menu_scavenger_sc"] = "Пулемётная хватка",
			...
			--MG Specialist
			["menu_sharpshooter_sc"] = "Пулемётчик",
		...
		--{
			...
			--Underdog--
			["menu_underdog_beta_sc"] = "Шестёрка",
			...
			--Fully Loaded--
			["menu_bandoliers_beta_sc"] = "Вооружён до зубов",
	...
	--}
		...
		--Low Blow--
		["menu_unseen_strike_beta_sc"] = "Подлый приём",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck13_3_desc_sc"] = "Увеличивает количество накапливаемого здоровья на ##3##.\n\nВаш уворот увеличен на ##5## очков.",
		["menu_deck13_5_desc_sc"] = "Вы можете накапливать на ##25%## больше здоровья.",
		["menu_deck13_7_desc_sc"] = "Увеличивает количество накапливаемого здоровья на ##3##.\n\nВаш уворот увеличен ещё на ##5## очков.",
