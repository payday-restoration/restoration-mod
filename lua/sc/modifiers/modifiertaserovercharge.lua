...
ModifierTaserOvercharge.zimbataser = {
...
function ModifierTaserOvercharge:modify_value(id, value)
	if id == "GroupAIStateBesiege:SpawningUnit" then
		...
		local is_taser_zimba = table.contains(ModifierTaserOvercharge.zimbataser, value)
		...
		elseif is_taser_zimba and math.random(0,100) < 10 then
			return Idstring("units/pd2_mod_halloween/characters/ene_titan_taser/ene_titan_taser")				
		end
	end
	return value
end