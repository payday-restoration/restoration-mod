function CopSound:init(unit)
	...
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_fbi_swat_1_sc/ene_fbi_swat_1_sc") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_swat_2_sc/ene_fbi_swat_2_sc") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_swat_3/ene_fbi_swat_3") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_heavy_1_sc/ene_fbi_heavy_1_sc") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_heavy_r870_sc/ene_fbi_heavy_r870_sc") or self._unit:name() == Idstring("units/payday2/characters/ene_shield_1_sc/ene_shield_1_sc") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	...
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_swat_1_sc/ene_swat_1_sc_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_swat_2_sc/ene_swat_2_sc_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_swat_heavy_1_sc/ene_swat_heavy_1_sc_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_swat_heavy_r870_sc/ene_swat_heavy_r870_sc_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_shield_2_sc/ene_shield_2_sc_husk") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_fbi_swat_1_sc/ene_fbi_swat_1_sc_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_swat_2_sc/ene_fbi_swat_2_sc_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_swat_3/ene_fbi_swat_3_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_heavy_1_sc/ene_fbi_heavy_1_sc_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_heavy_r870_sc/ene_fbi_heavy_r870_sc_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_shield_1_sc/ene_shield_1_sc_husk") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
