...
Hooks:PostHook( WeaponTweakData, "init", "SC_weapons", function(self)
	...
	--[[     LIGHT PISTOLS     ]]
		...
		--PRIMARIES
			...
			--Akimbo Baby Deagle
				...
				self.x_sparrow.ads_speed = 0.180
	...
	--[[     LIGHT SMGs     ]]
		...
		--PRIMARIES
			...
			--Hailstorm Mk5
				...
				self.hailstorm.ads_speed = 0.320
			...
			--Singature SMG (MPX)
				...
				self.shepheard.ads_speed = 0.200
	...
	--[[     LIGHT SNIPERS     ]]	
		...
		--PRIMARIES
			...
			--R700
				...
				self.r700.fire_rate_multiplier = 1.16666666
	...
	if self.stoner63a then --RJC9000 and PlayBONK's Stoner 63A
		--LMG
