...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck4_9_desc_sc"] = "Dodging an attack while your armor is broken regenerates health equal to ##50%## of the damage you would have taken. This effect can only occur once every ##3## seconds.\n\nDeck completion Bonus: Your chance of getting a higher quality item during PAYDAY is increased by ##10%.##",
