...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_paygrade"] = "Ступінь оплати: ",
		["menu_diffgrade"] = "Складність: ",
		...
		["res_saveboost"] = "УТРИМАЙТЕ $BTN_INTERACT ЩОБИ ПРОКАЧАТИСЯ ДО 100 РІВНЯ",

		["RestorationModOptionsButtonTitleID"] = "Настройкі Restoration Mod",
		["RestorationModOptionsButtonDescID"] = "Настройкі для Restoration Mod.",
		["RestorationModHUDOptionsButtonTitleID"] = "Настройкі інтерфейса Restoration Mod",
		["RestorationModHUDOptionsButtonDescID"] = "Настройкі інтерфейса в Restoration Mod.",
		["RestorationModOTHEROptionsButtonTitleID"] = "Додаткові настройкі Restoration Mod",
		["RestorationModOTHEROptionsButtonDescID"] = "Додаткові настройкі Restoration Mod.",
		["RestorationModUIOptionsButtonTitleID"] = "Alpha UI",
		["RestorationModUIOptionsButtonDescID"] = "Опціі Alpha UI.",
		["RestorationModTimeOfDayTitleID"] = "Нові та случані часи доби",
		["RestorationModTimeOfDayDescID"] = "Позволяе настраювати часи доби на дяких пограбуваннях.",

		["restoration_level_data_unknown"] = "НЕВІДОМИЙ ЧАС, НЕВІДОМЕ МІСТО",
		["RestorationModEnv_BanksTitleID"] = "Пограбування банку",
		["RestorationModEnv_BanksDescID"] = "Вибрати погоду для пограбування банку.",
		["RestorationModEnv_RVD1TitleID"] = "Скажені пси - день 1",
		["RestorationModEnv_RVD1DescID"] = "Вибрати погоду для пограбування Скажені пси (день 1).",
		["RestorationModEnv_RVD2TitleID"] = "Скажені пси - день 2",
		["RestorationModEnv_RVD2DescID"] = "Вибрати погоду для пограбування Скажені пси (день 2).",
		["RestorationModEnv_FSD1TitleID"] = "Підпалюватель - день 1",
		["RestorationModEnv_FSD1DescID"] = "Вибрати погоду для пограбування Підпалюватель (день 1).",
		["RestorationModEnv_PBR2TitleID"] = "Пташка у небі",
		["RestorationModEnv_PBR2DescID"] = "Вибрати погоду для пограбування Пташка у небі.",
		["RestorationModEnv_CJ2TitleID"] = "Бомба: Доки",
		["RestorationModEnv_CJ2DescID"] = "Вибрати погоду для пограбування Бомба: Доки.",
		["RestorationModEnv_UnderPassTitleID"] = "Транспорт: Проїзд",
		["RestorationModEnv_UnderPassDescID"] = "Вибрати погоду для пограбування Транспорт: Проїзд.",
		["RestorationModEnv_MallCrasherTitleID"] = "Руйнівник",
		["RestorationModEnv_MallCrasherDescID"] = "Вибрати погоду для пограбування Руйнівник.",
		["RestorationModEnv_Mia_1TitleID"] = "Г.Л.Майами - день 1",
		["RestorationModEnv_Mia_1DescID"] = "Вибрати погоду для пограбування Горяча лінія Майами (день 1).",
		["RestorationModEnv_FSD3TitleID"] = "Підпалюватель - день 3",
		["RestorationModEnv_FSD3DescID"] = "Вибрати погоду для пограбування Підпалюватель (день 3).",
		["RestorationModEnv_WDD1NTitleID"] = "Сторож. пси 1 (Ночь)",
		["RestorationModEnv_WDD1NDescID"] = "Вибрати погоду для пограбування Сторожові пси (день 1 - нічний).",
		["RestorationModEnv_WDD1DTitleID"] = "Сторож. пси 1 (День)",
		["RestorationModEnv_WDD1DDescID"] = "Вибрати погоду для пограбування Сторожові пси (день 1 - днівний).",
		["RestorationModEnv_WDD2DTitleID"] = "Сторож. пси 1 (День))",
		["RestorationModEnv_WDD2DDescID"] = "Вибрати погоду для пограбування Сторожові пси (день  - днівний).",
		...
		["RestorationModEnv_FSTitleID"] = "Чотири крамниці",
		["RestorationModEnv_FSDescID"] = "Вибрати погоду для пограбування Чотири крамниці.",
		["RestorationModEnv_UkraTitleID"] = "Українська справа",
		["RestorationModEnv_UkraDescID"] = "Вибрати погоду для пограбування Українська справа.",
		["RestorationModEnv_KosugiTitleID"] = "Нічний рейд",
		["RestorationModEnv_KosugiDescID"] = "Вибрати погоду для пограбування Нічний рейд.",
		...
		["RestorationModEnv_FRIENDDescID"] = "Вибрати погоду для пограбування Хатина Обличчя зі шрамом.",
		["RestorationModINFOHUDOptionsButtonTitleID"] = "Відображення іконок навичок (Buff Tracker)",
		["RestorationModINFOHUDOptionsButtonDescID"] = "Відображуе іконки навичок, які активні на даний момент, у лівому верхньому кутку екрану. Не требуе вімкнутого Alpha UI.",
		["RestorationModInfo_HudTitleID"] = "Увімкнути іконки навичок",
		["RestorationModInfo_HudDescID"] = "Увімкнути або вимкнути відображення іконки навичок.",
		["RestorationModInfo_SizeTitleID"] = "Розмір іконок",
		["RestorationModInfo_SizeDescID"] = "Регулюе розмір відобрадженних іконок навичок.",
		["RestorationModInfo_CountTitleID"] = "Число рядів",
		["RestorationModInfo_CountDescID"] = "Регулюе кількість рядів иконок навичок, які будут відображені, перш ніж додасться новий стовпчик.",
		["RestorationModInfo_single_shot_fast_reloadTitleID"] = "Агресивнє перезарядження",
		["RestorationModInfo_single_shot_fast_reloadDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_ammo_efficiencyTitleID"] = "Ефективна витрата",
		["RestorationModInfo_ammo_efficiencyDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_bloodthirst_reload_speedTitleID"] = "Кровожерливість",
		["RestorationModInfo_bloodthirst_reload_speedDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_bullet_stormTitleID"] = "Свинцевий зливень",
		["RestorationModInfo_bullet_stormDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_revive_damage_reductionTitleID"] = "Польовий медик",
		["RestorationModInfo_revive_damage_reductionDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_desperadoTitleID"] = "Відчаяний",
		["RestorationModInfo_desperadoDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_grinderTitleID"] = "Гістамін (Нападник)",
		["RestorationModInfo_grinderDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_infiltratorTitleID"] = "Крадій життя (Інтервент)",
		["RestorationModInfo_infiltratorDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_long_dis_reviveTitleID"] = "Натхнення",
		["RestorationModInfo_long_dis_reviveDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_messiahTitleID"] = "Месія",
		["RestorationModInfo_messiahDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_overkill_damage_multiplierTitleID"] = "Overkill",
		["RestorationModInfo_overkill_damage_multiplierDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_revived_damage_reductionTitleID"] = "Колеса",
		["RestorationModInfo_revived_damage_reductionDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_first_aid_damage_reductionTitleID"] = "Швидка допомога",
		["RestorationModInfo_first_aid_damage_reductionDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_rogueTitleID"] = "Смертельний інстинкт (Шпигун)",
		["RestorationModInfo_rogueDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_increased_movement_speedTitleID"] = "Рухомий від смерті",
		["RestorationModInfo_increased_movement_speedDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_headshot_fire_rate_multTitleID"] = "Влучний стрілець",
		["RestorationModInfo_headshot_fire_rate_multDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_trigger_happyTitleID"] = "Невгамовний стрілець",
		["RestorationModInfo_trigger_happyDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_dmg_multiplier_outnumberedTitleID"] = "Шістка",
		["RestorationModInfo_dmg_multiplier_outnumberedDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_unseen_strikeTitleID"] = "Удар исподтишка",
		["RestorationModInfo_unseen_strikeDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_survive_one_hitTitleID"] = "Татуювання Оні (Якудза)",
		["RestorationModInfo_survive_one_hitDescID"] = "Вімкнути або вимкнути відображеня іконок даного навичка.",
		["RestorationModInfo_doctor_bag_health_regenTitleID"] = "Лікування від Медичних сумок",
		["RestorationModInfo_doctor_bag_health_regenDescID"] = "Вімкнути або вимкнути відображеня лікування від Медичних сумок.",
		["RestorationModAltLastDownColorTitleID"] = "Інший фильтр для останнього паддіння",
		["RestorationModAltLastDownColorDescID"] = "Перемикає колірний фільтр при останньому падінні на color_sin_classic.",
		["RestorationModNoBleedoutTiltTitleID"] = "Відключити нахил камеру при падінні",
		...
		["RestorationModWaypointsDescID"] = "Включити або вимкнути іконки, що вказують на поточну мету з альфа-версії гри.",
		["RestorationModAssaultPanelTitleID"] = "Стрічка штурму з Альфи",
		["RestorationModAssaultPanelDescID"] = "Включити або вимкнути стрічку штурму з альфа-версії гри.",
		["RestorationModAltAssaultTitleID"] = "Індикатор штурму з ранньої Альфи",
		["RestorationModAltAssaultDescID"] = "Включити або вимкнути індикатор штурму з ранньої альфа-версії гри. Замінює стрічку штурму.",
		["RestorationModObjectivesPanelTitleID"] = "Панель завдань з Альфи",
		["RestorationModObjectivesPanelDescID"] = "Включити або вимкнути панель завдань з альфа-версії гри.",
		["RestorationModPresenterTitleID"] = "Презентер з Альфи",
		["RestorationModPresenterDescID"] = "Включити або вимкнути презентер з альфа-версії гри, які використовується при захопленні видобутку і для нагадування про завдання.",
		["RestorationModInteractionTitleID"] = "Шкала інтеракції з Альфи",
		["RestorationModInteractionDescID"] = "Включити або вимкнути шкалу інтеракції з альфа-версії гри.",
		["RestorationModStealthTitleID"] = "Індикатор скритності з Альфи",
		["RestorationModStealthDescID"] = "Включити або вимкнути індикатор скритності з Альфи. Використовується при Стелсі.",
		["RestorationModDownTitleID"] = "Таймер падіння з Альфи",
		["RestorationModDownDescID"] = "Включити або вимкнути таймер падіння з альфа-версії гри.",
		["RestorationModBagTitleID"] = "Панель сумок з Альфи",
		["RestorationModBagDescID"] = "Включити або вимкнути панель сумок з альфа-версії гри.",
		["RestorationModHostageTitleID"] = "Ховати панель заручників",
		["RestorationModHostageDescID"] = "Якщо включений, ховає панель заручників коли починається штурм, за умови, що стрічка або індикатор штурму з Альфи включені.",
		["RestorationModDifficultyMarkersTitleID"] = "Іконки складнощів з пре-релізу",
		["RestorationModDifficultyMarkersDescID"] = "Включити або вимкнути іконки складнощів з пре-релізу гри.",
		["RestorationModStaminaIndicatorTitleID"] = "Дебаговая смужка витривалості",
		["RestorationModStaminaIndicatorDescID"] = "Увімкнути або вимкнути дебагову смужку витривалості.",
		...
		["RestorationModLoadoutsTitleID"] = "Меню підготовки з Альфи",
		["RestorationModLoadoutsDescID"] = "Включити або вимкнути меню підготовки з альфа-версії гри.",
		["RestorationModDistrictTitleID"] = "Описи районів в CRIME.NET",
		["RestorationModDistrictDescID"] = "Включити або вилучити описи районів у CRIME.NET. описи не відповідають геймплею.",
		["RestorationModSCOptionsButtonTitleID"] = "Опції Restoration Overhaul",
		["RestorationModSCOptionsButtonDescID"] = "Опції Restoration Overhaul",
		...
		["RestorationModHolidayTitleID"] = "Святкові ефекти",
		["RestorationModHolidayDescID"] = "Включає або вимикає святкові ефекти в моді.",
		["RestorationModRestoreHitFlashTitleID"] = "Спалах при отриманні урону",
		["RestorationModRestoreHitFlashDescID"] = "Включити або вимкнути спалах екрану при отриманні урону зі старих версій гри.",	
		["RestorationModNotifyTitleID"] = "Увідомлення",
		["RestorationModNotifyDescID"] = "Включити або вимкнути повідомлення мода.",
		["RestorationModPauseTitleID"] = "Меню паузы з Альфы",
		["RestorationModPauseDescID"] = "Включити або вимкнути меню паузи з альфа-версії гри.",

		["menu_support"] = "Гайд / Допомога по ребалансу",
		["menu_support_help"] = "Переглянути гайд по ребалансу в Restoration Mod, отримати допомогу, знайти інших гравців.",
		["menu_manual_header"] = "Placeholder Text",
		["hud_assault_alpha"] = "ПОЛІЦЕЙСЬКИЙ ШТУРМ",
		...
		["restoration_level_data_welcome_to_the_jungle_1_night"] = "01:32, база байкерської банди 'Overkill'",
		["restoration_level_data_welcome_to_the_jungle_2"] = "18:00, Вілла Вівальді",
		["restoration_level_data_framing_frame_1"] = "23:30, Капітолійська картинна галерея",
		...
		["restoration_level_data_election_day_1"] = "12:37, Пірс 39",
		...
		["restoration_level_data_election_day_3_skip1"] = "16:25, Банк 'Капітолійський'",
		["restoration_level_data_election_day_3_skip2"] = "15:25, Банк 'Капітолійський'",
		["restoration_level_data_watchdogs_1"] = "16:10, Грузовик с мясом",
		["restoration_level_data_watchdogs_1_res"] = "21:10, вантажівка з м'ясом",
		["restoration_level_data_watchdogs_2"] = "00:25, Порт 'Альмендия'",
		["restoration_level_data_watchdogs_2_res"] = "00:25, Порт 'Альмендия'",
		["restoration_level_data_watchdogs_1_night"] = "1:10, вантажівка з м'ясом",
		["restoration_level_data_watchdogs_2_day"] = "18:05, Порт 'Альмендия'",
		["restoration_level_data_watchdogs_3_res"] = "00: 20 Міст 'Вашингтон Джастайс'",
		["restoration_level_data_alex_1"] = "03:30, Тихий пагорб",
		["restoration_level_data_alex_2"] = "05:55, Наркозховище",
		["restoration_level_data_alex_3"] = "07:20, Міст 'Вашингтон Джастайс'",
		["restoration_level_data_alex_1_res"] = "03:30, Тихий холм",
		["restoration_level_data_alex_2_res"] = "05:55, Наркозховище",
		["restoration_level_data_alex_3_res"] = "07:20, Міст 'Вашингтон Джастайс'",
		...
		["restoration_level_data_firestarter_2"] = "22:05, Офіс ФБР",
		["restoration_level_data_firestarter_2_res"] = "22:05, Офіс ФБР",
		["restoration_level_data_firestarter_3"] = "12:15, банк 'Харвест & трасті'",
		["restoration_level_data_firestarter_3_res"] = "12:15, банк 'Харвест & трасті'",
		["restoration_level_data_ukrainian_job"] = "14:50, 'Прекрасні штучки'",
		["restoration_level_data_ukrainian_job_res"] = "14:50, 'Прекрасні штучки''",
		["restoration_level_data_jewelry_store"] = "14:50, 'Прекрасні штучки''",
		["restoration_level_data_four_stores"] = "13:20, Магазини",
		["restoration_level_data_mallcrasher"] = "12:50, ТЦ 'Щит'",
		["restoration_level_data_nightclub"] = "20:00, Нічний клуб 'зі смаком'",
		["restoration_level_data_branchbank"] = "12:15, банк 'Харвест & трасті'",
		...
		["restoration_level_data_arm_par"] = "14:25, Центр міста",
		["restoration_level_data_arm_hcm"] = "14:15, Центр міста",
		["restoration_level_data_arm_cro"] = "12:55, Пересечение ул. МакКарти и ул. Джеймс",
		["restoration_level_data_arm_und"] = "20:15, Проїзд",
		["restoration_level_data_arm_for"] = "12:25, Поїзд 'Армаділло'",
		["restoration_level_data_family"] = "11:25 AM, Джойеллі ді Фамілья",
		["restoration_level_data_family_res"] = "11:25 AM, Джойеллі ді Фамілья",
		["restoration_level_data_big"] = "14:15, Банк 'Беневолент'",
		["restoration_level_data_big_res"] = "14:15, Банк 'Беневолент'",
		["restoration_level_data_roberts"] = "08:47, Банк 'Робєртс'",
		["restoration_level_data_roberts_v2"] = "08:47, Банк 'Робертс'",
		["restoration_level_data_mia_1"] = "21:30, Мотель Комісара",
		["restoration_level_data_mia_2"] = "11:45, Апартаменти Комісара",
		["restoration_level_data_mia2_new"] = "11:45, Апартаменти Комісара",
		["restoration_level_data_kosugi"] = "04:00, Склад 'Термінал'",
		["restoration_level_data_gallery"] = "23:45, Капітолійська картинна галерея",
		["restoration_level_data_hox_1"] = "10:30, Підземний перехід Будівлі суду",
		["restoration_level_data_hox_2"] = "16:10, Будівля ім. Джона Едгарда Гувера",
		["restoration_level_data_pines"] = "17:52, В глибині лісу",
		["restoration_level_data_mus"] = "20:15, Музей старовинного мистецтва ім. МакКендрика",
		["restoration_level_data_crojob2"] = "18:10, Вашингтонський порт",
		["restoration_level_data_crojob3"] = "15:35, Околиця лісу",
		["restoration_level_data_crojob3_night"] = "20:35, Околиця лісу",
		...
		["restoration_level_data_shoutout_raid"] = "09:00, Склад 'Термінал'",
		["restoration_level_data_arena"] = "21:00, GENSEC-Арена",
		["restoration_level_data_kenaz"] = "20:00, Лас-Вегас-Стрип-Казино 'Голден Грін'",
		["restoration_level_data_jolly"] = "16:00, Лос-Анджелес - Зона катастрофы",
		["restoration_level_data_red2"] = "14:15, ЦЕНТР МІСТА-ПЕРШИЙ СВІТОВИЙ БАНК",
		["restoration_level_data_dinner"] = "08:01, Район м'ясокомбінату - в засідці!",
		["restoration_level_data_nail"] = "00:00, Тихий пагорб",
		["restoration_level_data_haunted"] = "??:??, 'Притулок'",
		["restoration_level_data_pbr"] = "04:40, Невада-дослідницький центр 'Блекрідж'",
		["restoration_level_data_pbr2"] = "ЧАС НЕВІДОМИЙ, Z-170 'Зевс' - вантажний літак Murkywater",
		["restoration_level_data_cane"] = "15:15, Майстерня Санти",
		["restoration_level_data_peta"] = "12:00, Район в центрі міста",
		["restoration_level_data_peta2"] = "17:43, Зруйнований комору",
		["restoration_level_data_man"] = "18:00, Покинута будівля",
		["restoration_level_data_pal"] = "12:00, Передмістя-Ремонт сантехніки 'Bodhi'",
		["restoration_level_data_short1_stage1"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		["restoration_level_data_short1_stage2"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		["restoration_level_data_short2_stage1"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		["restoration_level_data_short2_stage2"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		["restoration_level_data_short2_stage2b"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		["restoration_level_data_dark"] = "02:21, Прихований вокзал",
		["restoration_level_data_mad"] = "ЧАС НЕВІДОМИЙ, десь в Росії...",
		["restoration_level_data_born"] = "10:15, Байкерський клуб OVERKILL",
		["restoration_level_data_chew"] = "17:25, за Вашингтоном-поїзд що йде!",
		["restoration_level_data_flat"] = "16:02, Неблагополучний район-Притон Чавеза",
		["restoration_level_data_chill"] = "13:00, Притулок",
		["restoration_level_data_chill_combat"] = "13:00, Притулок - рейд поліціі!",
		["restoration_level_data_help"] = "DON'T TOUCH THAT DIAL, WE'RE JUST GETTING STARTED",
		["restoration_level_data_friend"] = "16:30, Майамі-Особняк Ель Фурейдіс",
		["restoration_level_data_fish"] = "19:30, Біля Нью-Йорка-Яхта 'Літа'",
		["restoration_level_data_spa"] = "19:00, Ньй-Йорк - Засідка!",
		["restoration_level_data_moon"] = "23:00, Торговий центр 'Murica'",
		["restoration_level_data_run"] = "11:00, Житловий квартал - підстава!",
		["restoration_level_data_glace"] = "22:45, Міст Грін - південна сторона",
		["restoration_level_data_dah"] = "01:30, 22 поверх - Хмарочос Гарнет Груп",
		["restoration_level_data_hvh"] = "ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК. ТІК-ТАК.",
		["restoration_level_data_wwh"] = "ЧАС НЕВІДОМИЙ, десь на Алясці...",
		["restoration_level_data_rvd1"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		["restoration_level_data_rvd2"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		["restoration_level_data_brb"] = "18:53, Нью-Йорк, Бруклін-Банк 'Харвест & Трасті'",
		["restoration_level_data_des"] = "ЧАС НЕВІДОМИЙ, Невада - Скеля Генрі",
		["restoration_level_data_sah"] = "ЧАС НЕВІДОМИЙ, Массачусетс - Особняк Шеклторн",
		["restoration_level_data_tag"] = "00:43, Будівля ім. Джона Едгарда Гувера",
		["restoration_level_data_bph"] = "ЧАС НЕВІДОМИЙ, В'язниця ' Форт Клетсоп'",
		["restoration_level_data_nmh"] = "20:24, Госпіталь 'Милосердя' - ізоляційна палата",
		["restoration_level_data_vit"] = "13:07, Вашингтон - Білий дім",
		["restoration_level_data_mex"] = "ЧАС НЕВІДОМИЙ, США - Южная граница",
		["restoration_level_data_mex_cooking"] = "ЧАС НЕВІДОМИЙ, Мексика - база Койопов",
		["restoration_level_data_bex"] = "ЧАС НЕВІДОМИЙ, Мексика - Банк Сан Мартін",
		["restoration_level_data_pex"] = "ЧАС НЕВІДОМИЙ, Мексика - Поліцейська дільниця",
		["restoration_level_data_fex"] = "ЧАС НЕВІДОМИЙ, Мексика - Хатина Булука",
		...
		["restoration_level_data_wetwork"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		["restoration_level_data_junk"] = "ЧАС НЕВІДОМИЙ, ЛОКАЦІЯ ЗАСЕКРЕЧЕНА",
		...
		["heist_contact_shatter"] = "Джекєл",
		["heist_contact_akashic"] = "Ніко",

		["menu_contacts_shatter"] = "Союзники CRIMENET",
		
		["heist_contact_jackal_description"] = "Джекел почав свою карьеру в GenSec, но звільнився після інциденту, пов'язаного з торговлею людьми, у которому були замішанні GenSec и OMNIA.\n\nЗараз він працює на CRIMENET, піставляя халепу прямо ім на хату.",
		
		["heist_contact_akashic_description"] = "У прошлому - високопоставленный агент Гектора Моралеса, Ніколас 'Ніко' Рене зараз командуе залишками Синалоанского картеля в США. \nІх чисельність мала, і більший Колумбійський картель не збирається ні надавати допомогу, ні відновлювати союз з CRIMENET. Ніко об'єднується з різними дрібними бандами на східному узбережжі, а також з CRIMENET - він надасть свої ресурси в обмін на послуги.",

		["bm_msk_shatter_true"] = "Шаттер",
		["bm_msk_shatter_true_desc"] = "Легендарна маска, про яку говорять впівголоса.\n\nРозуміется, цу просто дублікат.\n\nУ справжній масці є дещо особливе, але думаю, вас влаштує і копія.\n\nФенікс символізує переродження того, хто не може бути убитий. Спробуй його знищити, і він лише завдасть вогненний контр-удар.",

		["menu_l_global_value_veritas"] = "Restoration Mod",
		["menu_l_global_value_veritas_desc"] = "Це предмет з Restoration Mod!",

		["menu_alex_1_zipline"] = "Зіплайн для сумок",

		["menu_asset_wet_intel"] = "Розвіддані",
		["menu_asset_risk_murky"] = "Найманці Murkywater",
		["menu_asset_risk_bexico"] = "Мексиканська федеральна поліція",
		["menu_asset_risk_zombie"] = "зОмбІ пОлІЦіЯ",
		["menu_asset_wet_boat"] = "Човен",
		["menu_asset_wet_boat_desc"] = "Купити додаткову точку скидання і втечі",

		["bm_msk_canada"] = "Пекельний хокей",
		["bm_msk_canada_desc"] = "Нічого не залишайте позаду - навіть коли стає жарко, ви боретеся за що хочете, коли хочете (навіть якщо це термобарична бомба).",
		["bm_msk_jsr"] = "Місіс Графіті",
		["bm_msk_jsr_desc"] = "Створена справжнім художником. Стирати графіті - все одно, що спалювати книги, чи не так?\n\nМистецтво це мистецтво - його потрібно поважати.",
		["bm_msk_jsrf"] = "Mістер Графіті",
		["bm_msk_jsrf_desc"] = "За кожним графіті стоїть історія. Бути художником у безликому місті може бути болісно.\n\nГрафіті-немов книга. Їх потрібно вміти читати.",
		["bm_msk_courier_stash"] = "Сумка для видобутку",
		["bm_msk_courier_stash_desc"] = "Якщо потрібно взяти кілька зайвих сотенних купюр, а в кишенях вже не залишилося місця, ця маска цілком зійде.",

		["bm_msk_female_mask"] = "Стандартна маска (жіноча)",
		["bm_msk_female_mask_desc"] = "Стандартна маска, надається організацією CRIMENET.\n\nЗроблена з щільного матеріалу, носити її не так просто, зате вона міцна.",
		["bm_msk_female_mask_blood"] = "Відновлена маска (жіноча)",
		["bm_msk_female_mask_blood_desc"] = "Стандартна маска, надається організацією CRIMENET.\n\nЗроблена з щільного матеріалу, носити її не так просто, зате вона міцна.\n\nЦя маска была знайдена після неудачного ограбления склада OMNIA, среди кровавого побоища.\n\nОстаннім посланням банди, перш ніж вони пропали назавжди, було ''ERIT PREMIUM SANGUINE SANCTUM''.",
		["bm_msk_female_mask_clown"] = "Розі",
		["bm_msk_female_mask_clown_desc"] = "Стандартна маска, надається організацією CRIMENET.\n\nЗроблена з щільного матеріалу, носити її не так просто, зате вона міцна.\n\nЦю маску носила грабіжниця, відома як Розі, хоча тепер у неї нова маска.\n\nНа відеозаписі з пограбування було видно, як вона знешкоджує цілий загін спецназу абсолютно без зброї.",
		["bm_msk_male_mask"] = "Стандартна маска (чоловіча)",
		["bm_msk_male_mask_desc"] = "Стандартна маска, надається організацією CRIMENET.\n\nЗроблена з щільного матеріалу, носити її не так просто, зате вона міцна.",
		["bm_msk_male_mask_blood"] = "Відновлена маска (чоловіча)",
		["bm_msk_male_mask_blood_desc"] = "Стандартна маска, надається організацією CRIMENET.\n\nЗроблена з щільного матеріалу, носити її не так просто, зате вона міцна.\n\nЦю маску носила грабіжниця, відома як Розі, хоча тепер у неї нова маска.\n\nНа відеозаписі з пограбування було видно, як вона знешкоджує цілий загін спецназу абсолютно без зброї''ERIT PREMIUM SANGUINE SANCTUM''.",
		["bm_msk_male_mask_clown"] = "Кросс",
		["bm_msk_male_mask_clown_desc"] = "Стандартна маска, що надається організацією CRIMENET.\n\nделана з щільного матеріалу, носити її не так просто, зате вона міцна.\n\nПету маску носив грабіжник, відомий як крос, хоча тепер у нього нова маска.\n\nКросс-талановитий Стрілець, і одного разу вивів з ладу чотири бронегрузовика за п'ять секунд.",

		["bm_msk_twister_mask"] = "Чоловік-загадка",
		["bm_msk_twister_mask_desc"] = "Хто ховається за цією маскою-загадка.\n\nМоже, це який-небудь незнайомець, а може-хто-небудь, кого ви знали весь цей час.",
		["bm_msk_voodoo_mask"] = "Тёмна магія",
		["bm_msk_voodoo_mask_desc"] = "Ця маска була знайдена в джунглях після бомбардування-вона змогла винести наслідки руйнувань, і тепер вважається передвісником біди.\n\nВона знайде вас, коли ви будете мати потребу в ній найбільше і допоможе пережити біду.\n\nПитання лише в тому, якою ціною.",

		["bm_msk_f1"] = "Шолом X1",
		["bm_msk_f1_desc"] = "Не забувайте про захист, коли будете нестися по шосе або прослизати через пробки.\n\nЦей шолом захистить від жорсткого падіння, але явно не від куль.",
		["bm_msk_f1_b"] = "Шолом X1 (Чистий)",
		["bm_msk_f1_b_desc"] = "Не забувайте про захист, коли будете нестися по шосе або прослизати через пробки.\n\nЦей шолом захистить від жорсткого падіння, але явно не від куль.\n\nЦе дублікат шолома, без брендових стікерів, який був знайдений в гаражі з дорогими машинами.\n\nТримайте цей шолом під рукою, і може бути одного разу, ви поїдете на одній з таких.",
		["bm_msk_sweettooth"] = "Ласун",
		["bm_msk_sweettooth_desc"] = "Ласун (справжнє ім'я - Маркус 'Нідлс' Кейн) - персонаж із серії ігор Twisted Metal. Ласун відомий як клоун-вбивця, який водить бойовий фургончик з морозивом.\n\nКажуть, одного разу він втік з психіатричної лікарні. Тепер він веде кримінальне життя.",

		["bm_msk_wolf_stone"] = "Вульф з Stonecold",
		["bm_msk_wolf_stone_desc"] = "Оригінальна маска Вульфа, яку він носив, коли вперше зійшов з розуму і почав втілювати злочини зі своїх улюблених ігор. Вважалося, що ця маска була загублена під час пограбування, натхненного грою 'Hyper Heisting'.\n\n ПО час ранніх пограбувань банди, маска знайшлася і була доставлена в притулок одним зі спільників Бейна.\n\n орігінальний візерунок маски з часом потьмянів, зовсім як психічна стабільність Вульфа.",

		["bm_msk_dallas_aged"] = "Стародавній Даллас",
		["bm_msk_dallas_aged_desc"] = "Ви з бандою виявили ці маски в дивній єгипетській скриньці, знайденої в скелі Генрі. Сама скринька виявилася загублена при перевезенні, але її вміст було передано вам.\n\nВ цих масках є щось незвичайне. Немає інформації, звідки вони могли з'явитися.\n\nДжекел вважає, що вони могли бути зроблені в якості практичної жарти, щоб налякати банду.\n\nОднак ви помічаєте, що ці маски виглядають дуже, дуже старими.",
		["bm_msk_chains_aged"] = "Стародавній Чейнс",
		["bm_msk_chains_aged_desc"] = "Ви з бандою виявили ці маски в дивній єгипетській скриньці, знайденої в скелі Генрі. Сама скринька виявилася загублена при перевезенні, але її вміст було передано вам.\n\nВ цих масках є щось незвичайне. Немає інформації, звідки вони могли з'явитися.\n\nДжекел вважає, що вони могли бути зроблені в якості практичної жарти, щоб налякати банду.\n\nОднак ви помічаєте, що ці маски виглядають дуже, дуже старими.",
		["bm_msk_hoxton_aged"] = "Стародавній Хокстон",
		["bm_msk_hoxton_aged_desc"] = "Ви з бандою виявили ці маски в дивній єгипетській скриньці, знайденої в скелі Генрі. Сама скринька виявилася загублена при перевезенні, але її вміст було передано вам.\n\nВ цих масках є щось незвичайне. Немає інформації, звідки вони могли з'явитися.\n\nДжекел вважає, що вони могли бути зроблені в якості практичної жарти, щоб налякати банду.\n\nОднак ви помічаєте, що ці маски виглядають дуже, дуже старими.",
		["bm_msk_wolf_aged"] = "Стародавній Вульф",
		["bm_msk_wolf_aged_desc"] = "Ви з бандою виявили ці маски в дивній єгипетській скриньці, знайденої в скелі Генрі. Сама скринька виявилася загублена при перевезенні, але її вміст було передано вам.\n\nВ цих масках є щось незвичайне. Немає інформації, звідки вони могли з'явитися.\n\nДжекел вважає, що вони могли бути зроблені в якості практичної жарти, щоб налякати банду.\n\nОднак ви помічаєте, що ці маски виглядають дуже, дуже старими.",

		["bm_msk_beef_dallas"] = "М`ясний Даллас",
		["bm_msk_beef_dallas_desc"] = "Банда використовувала ці маски під час пограбування 'м'ясокомбінат'.\n\nДаллас вирішив залишити дизайн своєї улюбленої маски.",
		["bm_msk_beef_chains"] = "М`ясний Чейнс",
		["bm_msk_beef_chains_desc"] = "Банда використовувала ці маски під час пограбування 'м'ясокомбінат'.\n\nЧейнс, будучи силовиком, захотів як дизайн страхітливу тварину. Що може бути страшнішим, ніж чортів динозавр?!",
		["bm_msk_beef_hoxton"] = "М`ясний Хокстон",
		["bm_msk_beef_hoxton_desc"] = "Банда використовувала ці маски під час пограбування 'м'ясокомбінат'.\n\nХокстон залишив простий список побажань для своєї маски:\n- Захістна!\n- Ефективна!\n- Стильная!\n\nТак і вийшла ця маска.",
		["bm_msk_beef_wolf"] = "М`ясний Вульф",
		["bm_msk_beef_wolf_desc"] = "Банда використовувала ці маски під час пограбування 'м'ясокомбінат'.\n\nДизайн Вульфа був натхненний його улюбленим персонажем, якого він вигадав, коли ще розробляв ігри.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--'Nade Launchers--
		["bm_wp_upg_a_grenade_launcher_incendiary_desc_sc"] = "Создаёт пламя при столкновении.\nПламя будет гореть 5 секунд в радиусе 7.5м и наносить 120 урона в секунду. Пламя имеет шанс поджечь врагов, прерывая их и нанося дополнительные 60 урона в течение 3 секунд.",
		["bm_wp_upg_a_grenade_launcher_incendiary_arbiter_desc_sc"] = "Создаёт пламя при столкновении.\nПламя будет гореть 5 секунд в радиусе 7.5м и наносить 80 урона в секунду. Пламя имеет шанс поджечь врагов, прерывая их и нанося дополнительные 60 урона в течение 3 секунд.",
		["bm_wp_upg_a_grenade_launcher_incendiary_ms3gl_desc_sc"] = "Создаёт пламя при столкновении.\nПламя будет гореть 5 секунд в радиусе 7.5м и наносить 40 урона в секунду. Пламя имеет шанс поджечь врагов, прерывая их и нанося дополнительные 60 урона в течение 3 секунд.",
		["bm_wp_upg_a_grenade_launcher_frag_desc_sc"] = "Детонирует при столкновении. Взрыв наносит 800 урона в радиусе 5 метров.",
		...
		["bm_wp_upg_a_grenade_launcher_poison_desc_sc"] = "Создаёт облако токсичного газа при столкновении.\nГаз держится 10 секунд в радиусе 6 метров и наносит 600 урона в течение 15 секунд, а также прерывает большинство врагов.",
		["bm_wp_upg_a_grenade_launcher_poison_arbiter_desc_sc"] = "Создаёт облако токсичного газа при столкновении.\nГаз держится 7.5 секунд в радиусе 6 метров и наносит 440 урона в течение 11 секунд, а также прерывает большинство врагов.",
		["bm_wp_upg_a_grenade_launcher_poison_ms3gl_desc_sc"] = "Создаёт облако токсичного газа при столкновении.\nГаз держится 5 секунд в радиусе 6 метров и наносит 280 урона в течение 7 секунд, а также прерывает большинство врагов.",
		...
		["bm_w_groza"] = "Винтовка ОБ-14ст Бык-4", --жуть, но лучше кепчука
		--ты чё 
		--бычара????
		--Eh, whatever
		["bm_groza_sc_desc_pc"] = "Буллпап-родственник винтовки 'Валькирия', любящий взрывы.\n\nНаносит 80% урона по броне. Нажмите $BTN_BIPOD чтобы переключиться на подствольный гранатомет.",
		["bm_groza_sc_desc"] = "Буллпап-родственник винтовки Валькирия, любящий взрывы.\n\nНаносит 80% урона по броне. Удерживайте $BTN_BIPOD чтобы переключиться на подствольный гранатомет.",
		...
		["bm_hk21_sc_desc"] = "Большая младшая сестра винтовки Gewehr-3.",	
		...
		--3GL
		["bm_ms3gl_sc_desc"] = "Стреляет укомплектованными вместе 40мм гранатами, позволяя быстро выстреливать по несколько зарядов.\nАльтернативный огонь выстреливает весь боезапас разом.",


		["bm_uzi_sc_desc"] = "Несмотря на возраст, Узи - надёжный и простой в обращении ПП.\nПеределан под калибр .45 ACP.",	
...
--[[   SKILLTREES   ]]--
	--{
		...
		--{
			...
			["menu_speedy_reload_desc_sc"] = "БАЗОВЫЙ: ##$basic##\nУ пулемётов есть ##40%## шанс сбить врага с ног при использовании сошек.\n\nНавык не действует на  капитанов, бульдозеров и щитов.\n\nПИКОВЫЙ: ##$pro##\nВы получаете на ##50%## меньше урона при использовании сошек.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--Burglar--
			["menu_st_spec_7_desc_sc"] = "Врождённая сноровка Взломщика позволяет ему выходить за рамки привычных взлома и проникновения. Чрезвычайная ловкость позволяет им быстрее взламывать замки, прятать тела и отвечать на пейджеры.\n\nПо ним очень трудно попасть. Они предпочитают держаться подальше от линии огня.\n\n\n\nБонусы полной колоды:\n##-##Ваш уворот увеличен на ##15## очков.\n##-##Ваш уворот заполняется на ##10%## за каждую секунду в приседе.\n##-##Вы используете мешки для трупов на ##20%## быстрее.\n##-##Вы взламываете замки на ##20%## быстрее.\n##-##Вы отвечаете на пейджеры на ##10%## быстрее.\n##-##Ваша броня восстанавливается быстрее на ##10%##.\n##-##Вы двигаетесь на ##10%## быстрее в приседе.",	
