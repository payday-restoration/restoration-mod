...
--[[   SKILLTREES   ]]--
	--{
		...
		--{
			...
			["menu_bandoliers_desc_sc"] = "БАЗОВЫЙ: ##$basic##\nВаш общий запас патронов увеличен на ##25%##.\n\nПИКОВЫЙ: ##$pro##\nВы подбираете на ##50%## больше патронов из коробочек.\n\nВы получаете шанс ##5%## восстановить метательное оружие от коробки патронов. Шанс повышается на ##1%## каждый раз, когда вы подбираете патроны и обнуляется, когда вы получаете метательное оружие.\nНе работает на метательное оружие из перков.",
