...
MutatorTitandozers.load_priority = -10  --idk about this tho
	...
	if not self._groups.tank then
		self._groups.tank = {
			...
			unit_types = {
				...
				zombie = { --this faction is missing in the vanilla mutator, thanks Jules :julesyes:
					Idstring("units/payday2/characters/ene_bulldozer_4/ene_bulldozer_4") 
				},
				murkywater = {
					Idstring("units/payday2/characters/ene_bulldozer_4/ene_bulldozer_4")
			...
			self._groups.tank = { --DS introduces all types of dozers (including Medicdozers)
				...
				unit_types = {
					...
					murkywater = {
						...
						Idstring("units/pd2_mod_sharks/characters/ene_murky_fbi_tank_medic/ene_murky_fbi_tank_medic"),  --temp model until we get a OMNIA Meddozer
						Idstring("units/pd2_dlc_vip/characters/ene_vip_2_assault/ene_vip_2_assault")
					},
					federales = {
						Idstring("units/pd2_dlc_bex/characters/ene_bulldozer_1/ene_bulldozer_1"),
