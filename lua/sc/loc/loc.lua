...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_melee_great_info"] = "Try thrusting attack, but hole.\n\nCharging an attack by at least 75% performs a thrusting attack, extending range by 1 meter.", -- Great Sword
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["loading_equip_skills_res_34"] = "Weapon butt melee speeds are affected by the weapon in your hands.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck22_9_desc_sc"] = "You can now activate the Leech Ampule while downed, temporarily reviving you until the end of the Leech Ampule. If you successfully revive or a teammate or use a Doctor Bag before the Ampule ends, you may stay alive if you are above 0 health.\n\nWhile the Leech Ampule is active your health is now divided into segments of ##10%##.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a PAYDAY is increased by ##10%.##",
