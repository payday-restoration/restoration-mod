...
function ElementSpawnEnemyDummy:init(...)
	...
	--TRY THE UNIVERSTIY OF TEXAS! COULDA GONE PRO IF I HADN'T JOINED THE NAVY! I"M NOT ONE OF THE BELTWAY PANSIES! I COULD BREAK PRESIDENT IN TWO.........WITH MY BARE HANDS!!	
	elseif ai_type == "texas" then
		--Very Hard			
		if difficulty_index <= 4 then
			if texas_very_hard[self._values.enemy] then
				self._values.enemy = texas_very_hard[self._values.enemy]
			end
			self._values.enemy = texas_very_hard[self._values.enemy] or self._values.enemy	
		--Overkill
		elseif difficulty_index == 5 then
			if texas_overkill[self._values.enemy] then
				self._values.enemy = texas_overkill[self._values.enemy]
			end
			self._values.enemy = texas_overkill[self._values.enemy] or self._values.enemy
		--Mayhem	
		elseif difficulty_index == 6 then
			if texas_mayhem[self._values.enemy] then
				self._values.enemy = texas_mayhem[self._values.enemy]
			end
			self._values.enemy = texas_mayhem[self._values.enemy] or self._values.enemy				
		--Deathwish		
		elseif difficulty_index == 7 then
			if texas_deathwish[self._values.enemy] then
				self._values.enemy = texas_deathwish[self._values.enemy]
			end
			self._values.enemy = texas_deathwish[self._values.enemy] or self._values.enemy			
		--deaf sentence XD						
		elseif difficulty_index == 8 then
			if texas_zeal[self._values.enemy] then
				self._values.enemy = texas_zeal[self._values.enemy]
			end
			self._values.enemy = texas_zeal[self._values.enemy] or self._values.enemy							
		end	
	--LAPD
