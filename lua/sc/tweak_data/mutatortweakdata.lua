...
Hooks:PostHook(MutatorTweakData, "init_piggybank", "res_init_piggybank", function(self, tweak_data)
	self.piggybank.drop_count = 4
	...
	--Lowered bag requirements
	self.piggybank.pig_levels[3].bag_requirement = 10
	self.piggybank.pig_levels[4].bag_requirement = 20
	self.piggybank.pig_levels[5].bag_requirement = 40
	self.piggybank.pig_levels[6].bag_requirement = 80
end)

Hooks:PostHook(MutatorTweakData, "init_piggyrevenge", "res_init_piggyrevenge", function(self, tweak_data)
	self.piggyrevenge.drop_count = 8
	...
	--Lowered bag requirements
	self.piggyrevenge.pig_levels[3].bag_requirement = 15
	self.piggyrevenge.pig_levels[4].bag_requirement = 30
	self.piggyrevenge.pig_levels[5].bag_requirement = 60
	self.piggyrevenge.pig_levels[6].bag_requirement = 120
	
	
	--Bonus points for using certain weapons
	self.piggyrevenge.weapon_kill_points.musket_crew = 10
	self.piggyrevenge.weapon_kill_points.musket = 10
