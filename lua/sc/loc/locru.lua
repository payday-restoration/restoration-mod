	...
	LocalizationManager:add_localized_strings({
		...
		--CUSTOM HANDGUNS AND ATTACHMENTS
			...
			-- PAYDAY 3 Bullkick 500
			  ["bm_w_bk500_desc"] = "Это чёртова портативная осадная пушка!\nДословно переводится как ''Пинок Быка 500''. И название не врёт, эта вещь звучит и бъёт как бык. Смотри чтоб руки твои не оторвало, вместе с головой несчастного копа по другую сторону ствола.",
		...
		--CUSTOM WEAPON ATTACHMENTS
					...
					["bm_wp_wpn_fps_ass_sta52_carry_handle_flipped"] = "Стандартная рукоятка для переноски с перевёрнутой мушкой",
		...
		--CUSTOM SMGs
            ...
            --BO6 Grendel R31
		    ["bm_w_r31_desc"] = "Полуавтоматический карабин, стреляющий калибром .22 Winchester Magnum. Произведён компанией ''Grendel Inc.''",
			--SBR .45
		...
		["bm_w_mx63_desc"] = "Дословно называется ''Испрыскателель Свинца''. Машина смерти и кошмар каждого законопослушника. По ясным причинам, этот пулемёт любимая игрушка Вульфа.",
		...
		-- TOZ-81 MARS
		  ...
		  ["bm_w_toz81_desc"] = "Прототип специального револьвера двойного действия, предназначеного для использования космонавтами, охотниками и геологами. Идея, конечно, была обещающей, но из-за неизвестных причин, ТОЗ-81 был отменён. Только один экземпляр был официально создан.",

		  ["bm_w_x_toz81"] = "Парные ТОЗ-81 МАРС",

        -- PAYDAY 3 FSA-12G
          ["bm_w_fsa12"] = "ФСА-12G",
          ["bm_w_fsa12_desc"] = "Этот дробовик плюётся свинцом с быстротой, зависимой от быстроты твоего пальца на курке. Зрелищный и идеальный среди всех дробовиков для зачистки комнат от полицейской пакости.",

                -- PAYDAY 3 M7 Pursuivant
                  ["bm_w_bp12_desc"] = "Компактный, точный и убойный дробовик, #{skill_color}#выпускает три заряда менее чем за секунду##. Не могу ничего сказать насчёт его надёжности и безопасности. Ох уж эти Турки...",

                -- PAYDAY 3 ORIGIN-12
		  ["bm_w_or12_desc"] = "Мощный, быстрый, и смертельный. Легко рвёт всё как бумагу. Смотри только, чтоб руки не оторвало.",
		...
		--CUSTOM ARs
			...
			--NV4
		          ...
		          ["bm_w_modl_desc"] = "Сильная винтовка калибра 7.62. Бъёт сильно, а также можёт стрелять на средней и дальней дистанции за счёт медленного темпа огня и предсказуемой отдачи.",

                        -- War Sport LVOA-C
		          ["bm_w_lvoac_desc"] = "Скорострельная винтовка с ультра-современным внешним видом. Произведена компанией ''War Sport''",

                        -- Half-Life 2 OSIPR
		          ["bm_w_ar2"] = "Импульсная Винтовка Альянса Стандартного Выпуска",
		          ["bm_w_ar2_desc"] = "Также известна как AR2, эта винтовка снабжена тёмной энергией и произведена Комбайнами.\n...Ну ладно-ладно! Альянсом! Грёбанная Бука...",

                        -- Fortnite Holo Twister
		          ["bm_w_holoar"] = "Штурмовая Винтовка ''Ураган''",
		          ["bm_w_holoar_desc"] = "Винтовка с встроенным прицелом. Имеет средний темп огня, хороший контроль, очень эффективна во многих боевых сценариях. Ну чё пацаны, куда дропаемся?",
			...
			--ПРЕСВЯТАЯ ДЕМОКРАТИЯ !!! HD2 AR-23 
					...
					["bm_w_ar23_desc"] = "Стандартная штурмовая винтовка ВССЗ, обладающая сбалансированными мощью, скорострельностью и весом, чтобы надёжно поражать небольшие цели.",
					["bm_wp_wpn_fps_ass_ar23_ck_carbine"] = "Набор АР-23А ''Карабин''",
					["bm_wp_ck_carbine_desc"] = "Компактная версия ''Освободителя'', отличающаяся повышенной эффективностью на ближней дистанции. Скорострельность повышенна за счёт увеличения разброса.#",
					["bm_wp_wpn_fps_ass_ar23_ck_penetrator"] = "Набор АР-23Р ''Пробойный''",
					["bm_wp_ck_penetrator_desc"] = "Модифицированная версия ''Освободителя'', оснащённая прицелом и #{skill_color}#бронебойными боеприпасами##, способными уничтожать бронированные цели.",
		...
		["bm_wp_shak12_body_vks_ap_desc"] = "Предоставляет еще более мощный калибр, который позволяет #{skill_color}#пробивать броню и щиты.## Приклад и затвор укреплены тяжелым материалом, что #{important_1}#уменьшает скорострельность.##",
			...
			--BR 14 Adjudicator
			["bm_w_br14"] = "Эксперт",
			["bm_w_br14_desc"] = "Точная бронебойная винтовка БР-14 ''Эксперт'' обрушивает праведную справедливость на цели среднего размера, но небольшой магазин ограничивает её эффективность против больших групп врагов.\n",
			--R-2 Amendment
	                ["bm_w_r2"] = "Поправка",
 	                ["bm_w_r2_desc"] = "Церемониальная полуавтоматическая винтовка со штыком. Можно установить режим трёх выстрелов, чтобы было проще совершать оружейный салют в честь Павших Героев.\n",

			-- RAID WWII BAR Heavy Rifle
	                  ["bm_w_m1918"] = "Тяжёлая винтовка BAR",
 	                  ["bm_w_m1918_desc"] = "Ещё один ребёнок Джона Браунинга. Большая и громоздкая вещь, наносящая большущий урон. Конечно, на один магазин только 20 патронов, но дружище, для таких ворошиловских стрелков, как ты, это не должно быть проблемой, ведь так?",

			-- Apex Legends G7 Scout
	                  ["bm_w_g7"] = "G7 Разведчик",
 	                  ["bm_w_g7_desc"] = "Наследник винтовок G2A4 и G2A5. Точная, мощная, сасная. Хорошо бъёт по головам на дальней дистанции. Обновлённый снайперский приклад отлично балансирует эффективность издалека и на средней дистанции.",
		...
		--Custom Snipers
	        ...
	        ["bm_w_r6_desc"] = "Мощная винтовка с рычажным затвором, позволяющим перезаряжать её по одному патрону. Высокая точность подходит для боя на средней и дальней дистанции.\n",
		--SVD
		...
		["bm_melee_moneybundle_info"] = "Один взмах - и жертва сразу поймёт, что проще банк ограбить, чем у него же занимать.",
		...
		["bm_wp_upg_af2011_a_uno_desc"] = "Позволяет стрелять из стволов поочерёдно.",
		
		--Nagant Revolver
		["bm_m1895_sc_desc"] = "Семизарядный револьвер прямиком из конца 19-ого века, который можно оснастить глушителем.#{risk}# Увы, но какой-то умник заменил барабан на стандартный.##\n\n#{skill_color}#Может пробивать броню, врагов, щитов и тонкие стены.##\n\nАльтернативный огонь выпускает боезапас с #{skill_color}#повышенной скоростью## за счёт #{important_1}#отдачи, точности и невозможности прицеливания.##",
		...
		--FP6
		["bm_w_fpsix_desc"] = "Этот помповый дробовик был подобран с мёртвого оперативника Мурок по прозвищу Гоуст.",
...
--Кастомные ПП
            ...
            ["bm_w_reprimand_desc"] = "Тяжёлый пистолет-пулемёт, использующий крупнокалиберные боеприпасы. Невысокая скорострельность помогает справиться с сильной отдачей.\n",
...
if not easterless then
	...
	if twirl <= shalashaska then
	 ...
	 if dragon <= kiwami then
		...
		["menu_deck12_1_desc_sc"] = "Чем меньше у вас здоровья, тем быстрее будет восстанавливаться полоска уворота, до максимальных ##$perk_value_1## уворота каждую секунду.\n\nВаш уворот увеличен на ##$perk_value_2## очков.\n\n#{important_1}#Среди Якудза татуировки (Иредзуми) являются 'удостоверением' c глубоким подтекстом.\nТе, кто носят на себе карпа кои, отличаются силой и храбростью, и рано или поздно им суждено превзойти почитаемого им дракона, чтобы стать онным.\n\nДо сих пор ходят легенды о двух подобных Карпу (с подозрительно схожими голосами). Один из них потерял всё и отступился от Кодекса ради того, чтобы стать сильнее и преодолеть Врата Дракона... Но после поражения в бою с Драконом он решил похоронить себя с 10 миллиардами йен, дабы спасти всех.\n\nГлупая смерть.##",
		...
		["menu_deck12_5_desc_sc"] = "Чем меньше у вас здоровья, тем меньше урона вы получаете, до максимальных ##$perk_value_1##.\n\nВы используете сумки для тел и взаимодействуете с гражданскими на ##$perk_value_2## быстрее.\n\n#{important_1}#Среди Якудза татуировки (Иредзуми) являются 'удостоверением' c глубоким подтекстом.\nТе, кто носят на себе тигра, отличаются пылкостью и грубой силой, которая может потягаться с силой дракона.\n\nМного подобных Тигру известно в криминальной среде Японии, но один из подобных прославился ещё в 1985 году, убив 18 главных членов противоборствуещего клана из шести револьверов и получив пожизненный срок с ожидающей смертной казнью.\n\nПравда, пули в револьверах были резиновые. Да и убил их совершенно другой человек.\nНо об этом узнали только 25 лет спустя.##.",
		["menu_deck12_7_desc_sc"] = "Чем меньше у вас здоровья, тем больше вы будете получать уворота при убийстве врага оружием ближнего боя, до максимальных ##$perk_value_1## уворота, а также период бессмертия следующего уворота будет увеличен, до максимальных ##$perk_value_2##, не превышая порог в ##$perk_value_3 мс##.\n\nВаш уворот увеличен еще на ##$perk_value_4## очков.\n\n#{important_1}#Среди Якудза татуировки (Иредзуми) являются 'удостоверением' c глубоким подтекстом.\nТе, кто носят на себе дракона, отличаются необычайной силой и мудростью.\nМножество подобных Дракону достигали успехов, но даже в легендах место найдётся только одному из них. Самый известный подобный Дракону дважды был выгнан из своей семьи и как-то сумел стать на день Четвертым председателем своего клана, чем связал свою жизнь с криминалом настолько, что ему пришлось инсценировать свою смерть ради родных ему людей.\n\n...И то этому помешала какая-то виртуальная ютуберша.##",
		["menu_deck12_9_desc_sc"] = "Максимальное количество устойчивости увеличено до ##$perk_value_1.##\n\nОдин раз за падение, если у вас закончится здоровье, вы выживите с ##1## здоровьем и восстановите ##$perk_value_2## брони.\n\nДанный перк не работает на удары Клокеров и шок Тазеров.\n\nБонус полной колоды: Шанс получения предмета высокого качества после прохождения ограбления увеличен на ##10%.##\n\n#{important_1}#Среди Якудза татуировки (Иредзуми) являются 'удостоверением' c глубоким подтекстом, но мало кто осмелится носить на себе Хання - вселяющую страх маску демона.\nВпрочем, один из подобных Хання прочно записал себя в легенды как «Бешенный пес» - образ, вдохновлённый прицнипу «получать больше удовольствия и жить безумнее, чем кто-либо».\nИронично, что этот подобный прожил дольше всех. И пускай он может где-то безпамятно лежать на пляже лицом вниз, мирные жители Кабуки-тё вряд ли забудут его голос.##\n\n«Йо... ##Кирю-чан!!!##»",
