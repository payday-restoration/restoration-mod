...
function HUDSuspicion:init(hud, sound_source)
	...
	local suspicion_left = self._suspicion_panel:bitmap({
		name = "suspicion_left",
		visible = true,
		texture = "guis/textures/restoration/hud_stealthmeter",
		color = Color(0, 1, 1),
		alpha = 1,
		valign = "center",
		w = 128,
	...
	local hud_stealthmeter_bg = self._misc_panel:bitmap({
		...
		visible = true,
		texture = "guis/textures/restoration/hud_stealthmeter_bg",
	...
	local hud_stealth_eye = self._misc_panel:bitmap({
		...
		visible = true,
		texture = "guis/textures/restoration/hud_stealth_eye",
		alpha = 0,
		w = 32,
		h = 32,
		valign = "center",
	...
	local hud_stealth_exclam = self._misc_panel:bitmap({
		...
		visible = true,
		texture = "guis/textures/restoration/hud_stealth_exclam",
		alpha = 0,
		w = 32,
		h = 32,
		valign = "center",
