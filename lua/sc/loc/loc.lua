...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--Leech
		["menu_st_spec_22_desc_sc"] = "You are a selective parasite in combat, draining your foes to strengthen yourself and your teammates. Still, you're not just some brick shithouse that can take a beating. You can dish out the pain and use that aggression to bolster your team.\n\n\n\n\n\nBenefits from a full perk deck:\n##-##Unlocks and equips the Leech Ampule, which lasts ##10## seconds and has a ##40## second cooldown, and the cooldown is reduced by ##1## second when killing enemies. When activated, restores ##10%## of your maximum health and disables armor during the Ampule's duration. It also divides your health into segments of ##10%## and any damage taken removes an entire segment which can be restored by killing ##4## enemies as well as blocking damage for ##1## second. Any damage taken restores ##2%## of your teammates maximum health.\n##-##You bag corpses and interact with hostages ##75%## faster.",
		["menu_deck22_1_desc_sc"] = "Unlocks and equips the ##Leech Ampule.##\n\nWhile in game you can use the throwable key to activate the Leech Ampule, activating it will restore ##10%## of your maximum health and disables your armor for the duration of the Leech Ampule.\n\nWhile the Ampule is active your health is divided into segments of ##20%## and damage taken from enemies will remove one segment. Killing ##4## enemies will restore one segment of your health and block damage for ##1## second.\n\nThe Leech Ampule lasts ##6## seconds with a ##40## second cooldown.",
		...
		["menu_deck22_7_desc_sc"] = "While the Leech Ampule is active your health is now divided into segments of ##10%.##",
