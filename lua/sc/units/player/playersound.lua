function PlayerSound:play_whizby(params)
	...
	sound_source:post_event("bullet_whizby_medium", callback(self, self, "clbk_whizby_finished", sound_source), nil, "end_of_event")
end

function PlayerSound:clbk_whizby_finished(sound_source)
