...
Hooks:Add("LocalizationManagerPostInit", "ResMod_Ruloc_Weapon_Names", function(loc)
	...
	--Кастомные оружия
		...
		--Кастомные ДМР
			...
			["bm_w_soa_desc"] = "Эффективность этой заряженной 7.62 патронами винтовки настолько высока, что для баланса Вселенной её пришлось убить в хлам, чтобы она не стала новой ''Vетой''.\nИли какие там словечки у геймеров, не знаю, олды на месте, как говорится.",
