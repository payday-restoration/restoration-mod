...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["loading_new_units_res_2"] = "OMNIA LPFs are weak to melee.",
		["loading_new_units_res_3"] = "Lighter units will be Overhealed by the OMNIA LPF. Overhealed enemies are outlined in purple. Overhealed units will always survive at least one shot.",
		...
		["loading_new_units_res_8"] = "Titan Shields can only be pierced with the Thanatos, Saw, and the special AP rounds in Sentry Guns.",
		...
		["loading_new_units_res_13"] = "Titan Swats are lightly resistant to melee, but it still works well as a finisher.",
		["loading_new_units_res_14"] = "Titan Swats cannot be taken hostage or converted to fight on your side.",
		["loading_new_units_res_15"] = "Titan Swats boast LMGs and automatic shotguns. They are a major threat to your well-being.",
		["loading_new_units_res_16"] = "The dreaded Bravo units spawn on Pro Jobs only, when a PONR is triggered. They are powerful no-nonsense enemies with very high Body HP and more powerful weapons.",
		...
		["loading_equip_skills_res_13"] = "Hacker is a mixed perk deck that provides powerful area denial and some healing on a long cooldown. It's also useful in Stealth.",	
		["loading_equip_skills_res_14"] = "Burglar is a special perk deck that provides small bonuses to Stealth in exchange for being a bit weaker than other decks in Loud.",	
		["loading_equip_skills_res_15"] = "Kingpin is a mixed perk deck that provides powerful survivability on a long cooldown. Enemies are much more likely to target you over teammates while the injector is active.",	
		...
		["loading_equip_skills_res_28"] = "The useless Armor Bag has been replaced by an Equipment Case like the one that can be bought as an asset on heists. It is unlocked the same way, though: through the Perk Decks.",	
