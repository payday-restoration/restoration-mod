if SC and SC._data.sc_ai_toggle or restoration and restoration.Options:GetValue("SC/SC") then
	...
	function CopActionShoot:_get_target_pos(shoot_from_pos, ...)
		...
		if (self._unit:base()._tweak_table == "deathvox_grenadier" or self._unit:base()._tweak_table == "boom" or self._unit:base()._tweak_table == "rboom") and self._throw_projectile_time < _time then
			if self._shooting_player then
				...
				if self._throw_projectile_time < _time then
					...
					if roll <= chance_gas and not managers.groupai:state()._cs_grenade and not Network:is_client() then
						...
						local dildo = _G.restoration.BufferedSounds.grenadier.use_gas
