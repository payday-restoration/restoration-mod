...
function PlayerStandard:set_night_vision_state(state)
	...
	if gradient_filter then
		local effect = state and night_vision.effect or tweak_data.levels[level_id].env_params.color_grading
	end
	local effect = state and night_vision.effect or managers.user:get_setting("video_color_grading")
