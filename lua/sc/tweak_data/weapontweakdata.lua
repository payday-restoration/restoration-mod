...
Hooks:PostHook( WeaponTweakData, "init", "SC_weapons", function(self)
	...
	--[[     LIGHT SNIPERS     ]]	
		...
		--Kang Arms X1 (QBU-88)
			...
			self.qbu88.fire_mode_data.fire_rate = 0.42857142
	...
	if self.x_socom then
		...
		self.x_socom.ads_speed = 0.150 * 1.5
