...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_melee_pattern_great"] = "Бьет атаками сверху вниз, а движения в сторону позволяют провести атаку с широким размахом. Заряженная атака (#{skill_color}#на 50% и более##) бьет выпадом вперед.",
