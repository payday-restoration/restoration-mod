...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["RestorationModQueuedShootingWindowDescID"] = "Determines the window of time for your fire inputs to be buffered based on a % of the weapon's fire time delay. Higher value = earlier buffer",
		...
		["RestorationModQueuedShootingMidBurstTitleID"] = "Mid-Burst Input Buffer (WIP)",
		["RestorationModQueuedShootingMidBurstDescID"] = "Buffer fire inputs done during a burst\nNOTE: Still a little buggy; inputs may not be put into the buffer.",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_menu_weapon_exp_no_hs_info"] = "#{risk}#Loaded with explosive ammo;## #{important_1}#cannot headshot.##",
		...
		["bm_xbow_exp_sc_desc"] = "#{risk}#Bolts explode on impact;## #{important_1}#cannot headshot.##",
		...
		["bm_airbow_exp_sc_desc"] = "#{risk}#Arrows explode on impact;## #{important_1}#cannot headshot.##",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["loading_new_units_res_8"] = "Titan Shields can be pierced with the Thanatos, OVE9000 Saw when using Rip and Tear basic or with special AP rounds in Sentry Guns. Even shooting their shield long enough can make them drop it but beware of their sudden tactic change.",
		...
		["loading_captains_res_5"] = "Captain Spring may be dangerous due to his pushback firepower, but he is incredibly slow and has poor range.",	
		...
		["loading_captains_res_11"] = "Captain Winters' shield is completely unpierceable but his shield can be shot off after shooting at it long enough. Beware of his Phase 2 though.",	
