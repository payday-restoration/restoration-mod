...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_pda10_post_objective_6_desc"] = "Убейте 50 врагов, используя оружия ближнего боя",
		["menu_pda10_post_objective_1_desc"] = "Убейте 50 дозеров",
		...
		["mutator_fullautoinbuilding_desc"] = "Титан снайперы и их эквиваленты теперь стреляют из своих винтовок в автоматическом режиме по игрокам, которые находятся близко к ним.",
		["mutator_fullautoinbuilding_longdesc"] = "Титан снайперы и их эквиваленты теперь стреляют из своих винтовок в автоматическом режиме по игрокам, которые находятся на расстоянии не более 10 метров.",
		
		["mutator_quickscope360"] = "Орлиный глаз",
		["mutator_quickscope360_desc"] = "Снайперы теперь прицеливаются быстрее на 100%.",
		["mutator_quickscope360_longdesc"] = "Снайперы теперь прицеливаются быстрее на 100%.",
