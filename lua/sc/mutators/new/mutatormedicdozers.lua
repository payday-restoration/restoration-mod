...
function MutatorMedicdozers:setup(data)
	...
	if difficulty_index <= 7 then 
		...
		table.insert(unit_types.omnia, Idstring("units/pd2_mod_omnia/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
		...
		table.insert(unit_types_black.omnia, Idstring("units/pd2_mod_omnia/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
		...
		table.insert(unit_types_skull.omnia, Idstring("units/pd2_mod_omnia/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
	else
