...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_melee_pattern_ballistic"] = "Атакует быстрыми ударами. Заряженная атака бьет размахом и сверху вниз. Движение в сторону влияет на направление атаки.", 
		["bm_melee_pattern_poker"] = "Бьет атаками сверху вниз. Заряженная атака бьет выпадом вперед.", 

		["bm_melee_pattern_boxcutter"] = "Бьет с широким размахом.", --Also works with "melee_catch" and "melee_agave"

		["bm_melee_pattern_shield"] = "Атакует обычным ударом. Заряженная атака бьет размахом.",

		["bm_melee_pattern_briefcsae"] = "Атакует обычным ударом. Заряженная атака бьет размахом.",

		["bm_melee_pattern_blunt"] = "Бьет атаками сверху вниз. Заряженная атака бьет размахом.", --Also works with "melee_brick", "melee_happy", "melee_cleaver", "melee_beardy"

		["bm_melee_pattern_axe"] = "Бьет атаками сверху вниз.", --Also works with "melee_psycho" and "melee_pickaxe"

		["bm_melee_pattern_cutter"] = "Бьет атаками сверху вниз. Заряженная атака бьет выпадом вперед.",

		["bm_melee_pattern_great"] = "Бьет атаками сверху вниз, а движения в сторону позволяют провести атаку с широким размахом. Заряженная атака бьет выпадом вперед.",
		...
		["bm_melee_pattern_fist"] = "Атакует быстрыми ударами. Заряженная атака позволяет прописать хук оппоненту. Движение в сторону влияет на направление атаки.",

		["bm_melee_pattern_boxing"] = "Атакует быстрыми ударами. Заряженная атака позволяет прописать оппоненту хук с левой или апперкот с правой. Движение в сторону влияет на направление атаки.",

		["bm_melee_pattern_tiger"] = "Атакует быстрыми ударами. Заряженная атака позволяет прописать оппоненту апперкот с левой или хук с правой. Движение в сторону влияет на направление атаки.",
