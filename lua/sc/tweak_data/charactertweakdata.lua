if SC and SC._data.sc_ai_toggle or restoration and restoration.Options:GetValue("SC/SC") then
	...
	function CharacterTweakData:_init_security(presets)
		...
		self.security.die_sound_event = "x01a_any_3p"
	...
	function CharacterTweakData:_init_gensec(presets)
		...
		self.gensec.die_sound_event = "x01a_any_3p"
	...
	function CharacterTweakData:_init_cop(presets)
		...
		self.cop.die_sound_event = "x01a_any_3p"
	...
	function CharacterTweakData:_init_fbi(presets)
		...
		self.fbi.die_sound_event = "x01a_any_3p"
		...
		if is_reaper then
		   self.fbi_vet.die_sound_event = "l4n_x01a_any_3p"
		else   
	...
	function CharacterTweakData:_init_swat(presets)
		...
		self.swat_titan.die_sound_event = "x01a_any_3p"
		...
		self.hrt.die_sound_event = "x01a_any_3p"
	...
	function CharacterTweakData:_init_heavy_swat(presets)
		...
		if is_murky then
			self.heavy_swat.die_sound_event = "x01a_any_3p"
		elseif is_zombie or is_reaper then
	...
	function CharacterTweakData:_init_fbi_swat(presets)
		...
		if is_murky then
			self.fbi_swat.die_sound_event = "x01a_any_3p"
		elseif is_zombie or is_reaper then
	...
	function CharacterTweakData:_init_city_swat(presets)
		...
		self.city_swat.die_sound_event_4 = "l1n_x01a_any_3p" --city swat dont get random death line presets fuk u
	...
	function CharacterTweakData:_init_shield(presets)
        ...
        if is_murky then
     		self.shield.die_sound_event = "x01a_any_3p"
		elseif is_zombie or is_reaper then
