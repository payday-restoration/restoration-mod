...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["restoration_level_data_pent"] = "11:30 PM, Сан Франциско - Пентхаус Юфу Венга",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_mp7_sc_desc"] = "Лёгкий ПП. Конкурент ПП Project-90. Оказывается, у неё нет подствольного гранатомёта.\n\nМожет пробивать броню.",
		...
		--Igor (APS)
		["bm_stech_sc_desc"] = "Тяжёлый и медленный автоматический пистолет, который потерял популярность из-за огромных габаритов. Его вес делает его стабильным за счёт скрытности.",
		["bm_x_stech_sc_desc"] = "Тяжёлый и медленный автоматический пистолет, который потерял популярность из-за огромных габаритов. Его вес делает его стабильным за счёт скрытности.",
		...
		["bm_melee_great_info"] = "Try thrusting attack, but hole.\n\nЗаряженные на 75% и более удары увеличивают дальность на 1 метр.", -- Great Sword
