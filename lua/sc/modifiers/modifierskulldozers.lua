...
function ModifierSkulldozers:init(data)
	...
	if difficulty_index <= 7 then 
		...
		table.insert(unit_types.nypd, Idstring("units/payday2/characters/ene_bulldozer_3/ene_bulldozer_3"))
		table.insert(unit_types.lapd, Idstring("units/payday2/characters/ene_bulldozer_3/ene_bulldozer_3"))		
	
		table.insert(unit_types_black.america, Idstring("units/payday2/characters/ene_bulldozer_3/ene_bulldozer_3"))
		...
		table.insert(unit_types_black.nypd, Idstring("units/payday2/characters/ene_bulldozer_3/ene_bulldozer_3"))
		table.insert(unit_types_black.lapd, Idstring("units/payday2/characters/ene_bulldozer_3/ene_bulldozer_3"))					
	else	
