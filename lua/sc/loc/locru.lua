...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_shak12_body_vks_ap_desc"] = "Предоставляет еще более мощный калибр, который позволяет #{skill_color}#пробивать броню и щиты.## Приклад и затвор укреплены тяжелым материалом, что #{important_1}#уменьшает скорострельность.##",	
            ...
            --Custom DMRs
			--MCX Spear
			["bm_mcx_spear_sc_desc"] = "#{skill_color}#Наносит 50% урона через броню. Попадания в голову наносят 33% бонусного урона.##",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Weapons", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_menu_bonus_concealment_p1"] = "Маленький бонус к Эргономичности и штраф к Стабильности",
		["bm_menu_bonus_concealment_p1_mod"] = "Маленький модификатор Эргономичности",
		["bm_menu_bonus_concealment_p2"] = "Большой бонус к Эргономичности и штраф к Стабильности",
		["bm_menu_bonus_concealment_p2_mod"] = "Большой модификатор Эргономичности",
		["bm_menu_bonus_concealment_p3"] = "Огромный бонус к Эргономичности и штраф к Стабильности",
		["bm_menu_bonus_concealment_p3_mod"] = "Огромный модификатор Эргономичности",
		...
		["bm_menu_concealment"] = "Эргономика\n",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["loading_equip_skills_res_20"] = "Чем выше Эргономика оружия, тем быстрее вы его достаете и убираете.",	
		...
		["loading_equip_skills_res_34"] = "Скорость удара прикладом зависит от Эргономики вашего оружия.",
        ...
        ["menu_crew_quiet"] = "Эргономичный",
        ["menu_crew_quiet_desc"] = "Игроки получают на 2 больше эргономичности.",
	...
	--[[   SKILLTREES   ]]--
		...
		--[[   GHOST   ]]--
			...
			--[[   ARTFUL DODGER SUBTREE   ]]--
				...
				["menu_thick_skin_beta_desc_sc"] = "БАЗОВЫЙ: #{owned}#$basic##\nУвеличивает эргономичность оружия ближнего боя на #{skill_color}#$skill_value_b1.##\n\nПИКОВЫЙ: #{owned}#$pro##\nУвеличивает эргономичность баллистических жилетов на #{skill_color}#$skill_value_p1##, а всей остальной брони на #{skill_color}#$skill_value_p2.##",
				...
				--Sneaky Bastard--
				["menu_jail_diet_beta_desc_sc"] = "БАЗОВЫЙ: #{owned}#$basic##\nВы получаете #{skill_color}#1## очко уворота за каждые #{skill_color}#3## очка нагрузки ниже #{skill_color}#35## до максимальных #{skill_color}#10## уворота.\n\nПИКОВЫЙ: #{owned}#$pro##\nВы получаете #{skill_color}#1## очко уворота за каждое #{skill_color}#1## очко нагрузки ниже #{skill_color}#35## до максимальных #{skill_color}#10## уворота.\n\nКогда ваша броня ломается, уворот от атаки восстанавливает #{skill_color}#$skill_value_p1## вашего здоровья. Это может произойти только один раз, пока ваша броня снова не сломается.",
