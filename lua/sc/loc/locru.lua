...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_melee_great_info"] = "Try thrusting attack, but hole.\n\nПолностью заряженные удары увеличивают дальность на 1 метр.", -- Great Sword
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["loading_equip_skills_res_1"] = "Дальнобойность дробовиков зависит от Точности - экспериментируйте и выясняйте, что подходит именно вам!",
		["loading_equip_skills_res_2"] = "Пистолеты очень быстро достаются, обладают высокой точностью и стабильностью.",
