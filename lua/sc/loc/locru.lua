...
Hooks:Add("LocalizationManagerPostInit", "ResMod_Ruloc_Weapons", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--CUSTOM WEAPON ATTACHMENTS
					...
					["bm_w_ar59_desc"] = "Автоматическая штурмовая винтовка с несъёмным глушителем и дозвуковыми боеприпасами. Медленные выстрелы отлично подходят для скрытых операций.",
					...
					["bm_wp_short_desc"] = "Укороченный и менее вместительный магазин. При этом более лёгкий и управляемый.",
					...
					["bm_wp_drum_desc"] = "Крайне вместительный, но при этом громодзкий и тяжёлый магазин.",

					["bm_wp_wpn_fps_ass_ar59_s_folded"] = "Складённый приклад",
                    ...
                    -- AR/GL-21 One-Two
					["bm_w_glar21"] = "Двоечка",
					["bm_w_glar21_desc"] = "Штурмовая винтовка, оснащённая гранатомётом. Универсальное, но тяжёлое оружие.",
					...
					["bm_wp_wpn_fps_scythe_m_heatsink_highcap"] = "Высокоёмкий радиатор",
					...
					["bm_w_senator_desc"] = "Мощный револьвер, который можно перезаряжать по одному патрону. Надёжное оружие, наносящее большой урон.",

					["bm_w_x_senator"] = "Парные Сенаторы",
					["bm_w_x_senator_desc"] = "Личная разработка Генерала Браша. Так можно только ему, и его наследовательным 10-звёздочным Генералам.",
		...
		--CUSTOM SMGs
	        ...
	        ["bm_wp_wpn_fps_smg_r31_m_fastreload2"] = "Быстросъёмный Магазин I",

	        ["bm_wp_wpn_fps_smg_r31_s_adsmove"] = "Приклад Инфильтратора",
	        ["bm_wp_wpn_fps_smg_r31_s_flinch"] = "Тяжёлый Приклад",
		...
		--CUSTOM ARs
			...
			--NV4
		          ...
		          ["bm_wp_wpn_fps_ass_modl_b_3"] = "Закалённый Ствол",
		          ["bm_wp_wpn_fps_ass_modl_b_4"] = "Длинный Ствол",

		          ["bm_wp_wpn_fps_ass_modl_m_2"] = "Удлинённый Магазин I",
		          ["bm_wp_wpn_fps_ass_modl_m_3"] = "Удлинённый Магазин II",
		          ...
		          ["bm_wp_wpn_fps_ass_modl_s_3"] = "Тяжёлый Приклад",
		          ["bm_wp_wpn_fps_ass_modl_s_4"] = "Лёгкий Приклад",
		          ...
		          ["bm_wp_wpn_fps_ass_soa_s_2"] = "Тяжёлый Приклад Motion-V2",
		          ["bm_wp_wpn_fps_ass_soa_s_3"] = "Точный Приклад STT-88",
		          ["bm_wp_wpn_fps_ass_soa_s_4"] = "Тяжёлый и Точный Приклад ST-Motion V3",
		          ...
		          ["bm_wp_wpn_fps_ass_fik22_mag_quick"] = "Быстросъёмный Магазин",
		          ...
		          ["bm_wp_gauss_extmag_desc"] = "Уникальный прототип улучшенного магазина для Гаусс-Пушки. Имеет намного больше запаса энергии, позволяя стрелять дольше, но взамен придётся попрощаться с точьностью из-за нестабильного потребления энергии.",
