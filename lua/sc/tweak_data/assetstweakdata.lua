...
function AssetsTweakData:_init_risk_assets(tweak_data)
	...
	table.insert(self.risk_pd.exclude_stages, "corp")	
	...
	table.insert(self.risk_swat.exclude_stages, "corp")	
	...
	table.insert(self.risk_fbi.exclude_stages, "corp")	
	...
	table.insert(self.risk_death_squad.exclude_stages, "corp")
	...
	table.insert(self.risk_easy_wish.exclude_stages, "corp")
	...
	table.insert(self.risk_death_wish.exclude_stages, "corp")
	...
	table.insert(self.risk_sm_wish.exclude_stages, "corp")
