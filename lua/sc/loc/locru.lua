...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_a_grenade_launcher_electric_desc_sc"] = "Производит электроразряд при попадании. Разряд наносит 400 урона в радиусе 5 метров, и имеет шанс поразить врагов током.",
		["bm_wp_upg_a_grenade_launcher_electric_arbiter_desc_sc"] = "Производит электроразряд при попадании. Разряд наносит 300 урона в радиусе 2.5 метров, и имеет шанс поразить врагов током.",
