...
function BlackMarketTweakData:_init_melee_weapons(tweak_data)
	...
	self.melee_weapons.boxing_gloves.stats.max_damage_effect = 12
	...
	self.melee_weapons.briefcase.stats.max_damage = 9.001
	...
	self.melee_weapons.freedom.stats.max_damage = 18.001
	...
	self.melee_weapons.poker.stats.max_damage = 18.001
	...
	self.melee_weapons.micstand.stats.max_damage = 12.001
	...
	self.melee_weapons.slot_lever.stats.min_damage_effect = 4
	...
	self.melee_weapons.croupier_rake.stats.max_damage_effect = 4
	...
	self.melee_weapons.twins.stats.max_damage = 12.001
	...
	self.melee_weapons.gator.stats.max_damage = 9.001
	...
	self.melee_weapons.pitchfork.stats.max_damage = 18.001
	...
	self.melee_weapons.scoutknife.stats.min_damage_effect = 0.66666
	...
	self.melee_weapons.road.stats.max_damage = 12.001
	...
	self.melee_weapons.cs.stats.min_damage_effect = 0.8
	self.melee_weapons.cs.stats.max_damage_effect = 0.8
	...
	self.melee_weapons.ostry.stats.min_damage_effect = 0.4
	self.melee_weapons.ostry.stats.max_damage_effect = 0.4
	...
	self.melee_weapons.oxide.stats.max_damage = 12.001
	...
	self.melee_weapons.meter.stats.max_damage = 18.001
...
Hooks:PostHook(BlackMarketTweakData, "init", "CustomMelee", function(self, tweak_data)	
	...
	if self.melee_weapons.hfblade then --HF Blade (Katana 2x speed, 1/2 damage)
		...
		self.melee_weapons.hfblade.anim_speed_mult = self.melee_weapons.hfblade.anim_speed_mult * 2
	end

	if self.melee_weapons.murasama then --HF Murasama (Katana 2x speed, 1/2 damage)
		...
		self.melee_weapons.murasama.anim_speed_mult = self.melee_weapons.murasama.anim_speed_mult * 2
	end
