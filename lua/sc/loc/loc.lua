	...
	LocalizationManager:add_localized_strings({
		...
		["RestorationModHUDOptionsButtonDescID"] = "Restoration's HUD & UI Options.",
			...
			["RestorationModINFOHUDOptionsButtonDescID"] = "Displays icons to reflect information about active skills on the left side of the screen. Does not require Alpha UI to be enabled.",
				...
				["RestorationModInfo_throwable_regenTitleID"] = "Throwable Regen Boost",
				["RestorationModInfo_throwable_regenDescID"] = "Enables or disables tracking of throwable regen boosts from ordnance bags and throwable cases.",
	...
	--[[   SKILLTREES   ]]--
		...
		--[[   ENFORCER   ]]--
			...
			--[[   SUPPORT SUBTREE   ]]--
				...
				["menu_bandoliers_desc_sc"] = "BASIC: #{owned}#$basic##\nYou pick up #{skill_color}#$skill_value_b1## more ammo from ammo boxes.\n\nACE: #{owned}#$pro##\nYour total ammo capacity is increased by #{skill_color}#$skill_value_p1## and you carry #{skill_color}#$skill_value_p2## more throwables.\n\nYour ammo box regen bonus for your throwables is increased by #{skill_color}#$skill_value_p3.##",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks_Eng", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--Biker--
		["menu_deck16_1_desc_sc"] = "You and your crew (henceforth \"crew members\") may gain Cohesion stacks. Cohesion stacks tend to a number equal to $perk_value_1 times the amount of crew members nearby for each crew member, but only as long as they are within #{skill_color}#$perk_value_2## of you and you are not downed. This means that if their Cohesion stacks are below this amount, they gain #{skill_color}#$perk_value_3## Cohesion stack every second, but lose #{important_1}#$perk_value_4## Cohesion stacks every second otherwise. This tendency grows faster the farther away a crew member's Cohesion stacks are from the target amount.\nCrew members lose #{important_1}#$perk_value_5## Cohesion stack for every #{skill_color}#$perk_value_6## damage taken, with health damage weighed doubly.\n\n#{risk}#NOTE: Card benefits do not stack if multiple Biker users select the same, and Cohesion stacks are not gained faster from multiple Biker users nearby. If multiple Biker users near one another have would have their Cohesion stacks tend to different amount, the higher one wins.##",
		["menu_deck16_1_short_sc"] = "Crew members may gain Cohesion stacks. Crew members' Cohesion stacks increase from proximity to one another, and decrease otherwise or when taking damage.",
		...
		["menu_deck16_9_2_desc_sc"] = "Crew members regenerate armour #{skill_color}#$perk_value_1## faster for every 8 stacks of Cohesion they have.\nIn addition, crew members gain an additional #{skill_color}#$perk_value_2## armour for every 8 stacks of Cohesion they have.\n\n#{risk}#NOTE: This additional armour is added before any other multiplications to one's armour, such as Stoic's Virtue (Card 1), and is based on your armour's base armour value.##",
		["menu_deck16_9_2_short_sc"] = "Crew members regenerate armour #{skill_color}#$perk_value_1## faster for every 8 stacks of Cohesion they have. In addition, crew members gain an additional #{skill_color}#$perk_value_2## armour for every 8 stacks of Cohesion they have.",
