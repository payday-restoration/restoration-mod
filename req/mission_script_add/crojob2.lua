...
local shields = ((difficulty >= 8 and pro_job)    and "units/pd2_mod_sharks/characters/ene_zeal_swat_shield/ene_zeal_swat_shield" or "units/pd2_dlc_vip/characters/ene_phalanx_1_assault/ene_phalanx_1_assault")
