...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_a_custom_desc"] = "Fires #{important_1}#6## larger, heavier pellets that #{skill_color}#increase## damage, the sheer force of these rounds #{skill_color}#dealing 20% of their damage through body armor.##",
		...
		["bm_wp_upg_a_dragons_breath_semi_desc_sc"] = "Fires magnesium shards that have up to a #{skill_color}#20%## chance to #{heat_warm_color}#set enemies on fire##, dealing #{heat_warm_color}#120## damage over #{skill_color}#3## seconds.\n\n#{risk}#Chance is reduced over range and can only stun enemies before damage falloff starts.##",
		["bm_wp_upg_a_dragons_breath_pump_desc_sc"] = "Fires magnesium shards that have up to a #{skill_color}#30%## chance to #{heat_warm_color}#set enemies on fire##, dealing #{heat_warm_color}#180## damage over #{skill_color}#3## seconds.\n\n#{risk}#Chance is reduced over range and can only stun enemies before damage falloff starts.##",
		["bm_wp_upg_a_dragons_breath_heavy_desc_sc"] = "Fires magnesium shards that have up to a #{skill_color}#40%## chance to #{heat_warm_color}#set enemies on fire##, dealing #{heat_warm_color}#240## damage over #{skill_color}#3## seconds.\n\n#{risk}#Chance is reduced over range and can only stun enemies before damage falloff starts.##",
		...
		["bm_wp_upg_a_rip_semi_desc_sc"] = "Fires #{stats_positive}#poison laced## buckshot, potentially stunning enemies and dealing #{stats_positive}#60## poison damage over #{skill_color}#2## seconds.",
		["bm_wp_upg_a_rip_pump_desc_sc"] = "Fires #{stats_positive}#poison laced## buckshot, potentially stunning enemies and dealing #{stats_positive}#90## poison damage over #{skill_color}#3## seconds.",
		["bm_wp_upg_a_rip_heavy_desc_sc"] = "Fires #{stats_positive}#poison laced## buckshot, potentially stunning enemies and dealing #{stats_positive}#120## poison damage over #{skill_color}#4## seconds.",
	...
	--[[   SKILLTREES   ]]--
		...
		--[[   ENFORCER   ]]--
			...
			--[[   SHOTGUNNER SUBTREE   ]]--
				...
				["menu_overkill_desc_sc"] = "BASIC: #{owned}#$basic##\nKills using #{skill_color}#shotguns, flamethrowers or OVE9000 saw## grants them a #{skill_color}#50%## damage boost for #{skill_color}#2## seconds.\n\nACE: #{owned}#$pro##\nThe damage bonus now applies to all weapons and lasts #{skill_color}#10## seconds. Skill must still be activated using a #{skill_color}#shotgun, flamethrower or OVE9000 saw.##\n\n#{risk}#NOTE: The damage bonus does not apply to launchers.##\n\nDecreases the time it takes to pull and put away #{skill_color}#shotguns, flamethrowers and the OVE9000 saw## by #{skill_color}#50%.##",
