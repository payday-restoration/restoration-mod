...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_o_angled_laser_desc"] = "Press #{skill_color}#$BTN_GADGET## while aiming to switch between aiming down your sights and #{risk}#point shooting.##\nWhile point shooting you aim #{skill_color}#25%## faster and aimed movement speeds are #{skill_color}#40%## faster; in exchange your aimed accuracy is reduced by #{important_1}#2000%.##\n\n#{risk}#the use of a laser gadget is highly recommended.##", --VMP Point Shoot Laser
