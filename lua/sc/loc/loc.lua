...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck12_7_desc_sc"] = "The lower your health, the more your effective your dodge becomes when you kill an enemy with melee.\n\nWhen your health is below ##100%##, your meter fills by up to ##100%## of your dodge, stacking with the effects of Hebi Irezumi, as well as increasing the grace period of your next dodge by up to ##400%##, to a maximum of ##1.2## seconds\n\nYour dodge is increased by an additional ##5## points.",
