...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--S552
		["bm_s552_sc_desc"] = "다른 소형 5.56mm 소총에 대한 훌륭한 대안용 총, 국토감시부에서 선호하는 총이기도 합니다.",				
		--M733/AMCAR
		...
		["bm_ak74_sc_desc"] = "7.62 자매보다 작은 탄을 발사하지만 이게 덜 치명적인 것이라는 건 아닙니다.",	
		--Union 5.56
		...
		--RPK
		["bm_rpk_sc_desc"] = "총알 호스가 목표물과 조금 더 동부 방식을 원할 때는 이 총을 고르는게 좋은 선택입니다.\n\n지향 사격 시 명중률이 매우 감소합니다.",							

		--Brenner 21/HK21
		["bm_w_hk21"] = "Brenner-21 중기관총",
		["bm_hk21_sc_desc"] = "Gewehr-3의 제일 작은 여동생. 제압 사격 능력을 더 늘리기 위해 증가된 발사 속도와 함께 제공합니다\n\n지향 사격 시 명중률이 매우 감소합니다.",		
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["loading_gameplay_res_23"] = "적들은 더 높은 난이도에서 실드를 더 잘 사용할 것입니다.",
...
--[[   SKILLTREES   ]]--
	--{
		...
		--{
			...
			["menu_jail_workout_desc_sc"] = "베이직: ##$basic##\n마킹된 적의 지속시간을 ##100%##만큼 증가시킵니다.\n\n에이스: ##$pro##\n이제 ##스텔스에서 특수 적과 경비를 아무 무기로든 조준하여 마킹할 수 있습니다.##",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck3_9_desc_sc"] = "방탄복 회복률이 추가로 ##10%##만큼 증가합니다.\n\n덱 완성 보너스: PAYDAY 카드에서 높은 등급의 아이템을 얻을 확률이 ##10%## 상승합니다.",
		...
		--Leech
		["menu_st_spec_22_desc_sc"] = "여러분은 전투 중 먹잇감을 고르는 거머리 같은 존재입니다. 적의 생기를 빨아서 자신과 동료를 튼튼하게 하지요. 그럼에도, 여러분은 아무나 와서 두들겨 팰 수 있는 옥외변소 같은 존재 역시 아닙니다. 여러분은 적에게 상당한 고통을 선사하며 그러한 공격성으로 팀의 전력을 강화할 수 있습니다.\n\n\n\n\n\n전체 특성 덱의 이점:\n##-## ##10##초 동안 지속되고 ##30##초의 재사용 대기시간을 가지며, 적을 죽일때마다 재사용 대기시간이 ##1##초씩 감소하는 리치 약병을 잠금 해제하고 장착합니다. 활성화 시 최대 체력의 ##40%##를 회복하고 약병 지속 시간 동안 방탄력을 비활성화합니다. 또한 당신의 체력을 ##10%## 부분씩 분할로 나누고, 모든 피해를 입으면 한 분할을 제거합니다. 이 부분은 적을 ##2##명씩 죽이면 회복할 수 있고 ##1##초 동안 피해를 받지않습니다. 받는 피해는 팀원의 ##4%## 최대 체력을 회복합니다.\n##-##리치 약병이 활성화되어 있는 동안 출혈 상태에 빠질 수는 없게되지만 체력이 전부 떨어지면 이동 속도가 ##80%##만큼 느려집니다.\n##-##최대 체력이 ##15%##만큼 증가합니다.\n##-##이제 리치 약병을 쓰러진 상태에서 활성화하여 리치 약병이 끝날 때까지 일시적으로 소생될 수 있습니다. 약병이 끝나기 전에 팀원을 성공적으로 소생시키거나 체력이 0 이상인 상태에서 의료 가방을 사용하면 살아남을 수 있습니다..\n##-##시체 가방을 싸는 시간과 인질을 상호작용 하는 속도가 ##75%##만큼 빨라집니다.",
		["menu_deck22_1_desc_sc"] = "##리치 약병##을 잠금 해제하고 장비합니다.\n\n게임 내에서 투척무기 키를 사용하여 리치 약병을 활성화할 수 있으며, 활성화하면 최대 생명력의 ##40%##를 회복하고 리치 약병이 지속되는 동안 방탄력을 비활성화합니다.\n\n약병이 활성화되어 있는 동안 체력을 ##20%## 부분씩 분할되고 적으로부터 피해를 받으면 하나의 분할을 제거합니다. 적을 ##2##명씩 죽이면 체력의 한 분할을 회복하고 ##1##초 동안 피해를 입지 않습니다. 체력 피해를 입을 때마다 팀원 최대 체력의 ##2%##씩 회복합니다.\n\n리치 약병은 ##6##초 동안 지속되며 재사용 대기시간은 ##30##초입니다.",
		["menu_deck22_3_desc_sc"] = "최대 체력이 ##5%##만큼 증가합니다.\n\n리치 약병이 활성화되어 있는 동안 출혈 상태에 빠질 수는 없게되지만 체력이 전부 떨어지면 이동 속도가 ##80%##만큼 느려집니다.",
		["menu_deck22_5_desc_sc"] = "리치 약병의 지속시간이 ##10##초로 증가합니다.\n\n적을 죽이면 리치 약병의 재사용 대기시간이 ##1##초씩 감소합니다.\n\n피해를 입으면 이제 팀원의 체력이 ##4%##씩 회복합니다.\n\n시체 가방을 싸는 시간과 인질을 상호작용 하는 속도가 ##75%##만큼 빨라집니다.",
		["menu_deck22_7_desc_sc"] = "최대 체력이 추가로 ##10%##만큼 증가합니다.",
		["menu_deck22_9_desc_sc"] = "이제 리치 약병을 쓰러진 상태에서 활성화하여 리치 약병이 끝날 때까지 일시적으로 소생될 수 있습니다. 약병이 끝나기 전에 팀원을 성공적으로 소생시키거나 체력이 0 이상인 상태에서 의료 가방을 사용하면 살아남을 수 있습니다.\n\n이제 리치 앰플이 활성화되어 있는 동안 체력을 ##10%## 부분씩 분할됩니다.\n\n덱 완성 보너스: PAYDAY 카드에서 높은 등급의 아이템을 얻을 확률이 ##10%## 상승합니다.",
