...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["st_menu_firemode_volley"] = "АВТО+ЗАЛП",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks", function(loc)
	...
	["menu_deck_kmerc_1_desc_sc"] = "Годы сражений сделали вашу кожу крепкой. Урон от сильных атак снижен, ##вас не могут убить одной атакой##.\n\nВы получаете на ##5%## больше здоровья.",
	["menu_deck_kmerc_3"] = "Чрезмерная сила",
	["menu_deck_kmerc_3_desc_sc"] = "Силу встречают силой! Вы получаете ##1%## к шансу критической атаки за каждые ##20## максимальной брони.\n\nВы получаете на ##10%## больше брони.",
	["menu_deck_kmerc_5"] = "Отстранись",
	["menu_deck_kmerc_5_desc_sc"] = "Когда ваше здоровья становится ##0##, оно становится ##1##, а вы получаете ##2## секунды неуязвимости. Мы продержимся...\nВо время неуязвимости нельзя бежать.\nЭтот эффект не может повториться, пока вы не вылечитесь до 100% здоровья.\n\nВы получаете на ##5%## больше здоровья.",
	["menu_deck_kmerc_7"] = "Лечебный слой",
	["menu_deck_kmerc_7_desc_sc"] = "Внутренний слой вашей брони покрыт препаратами и гемостатиками. Если ваша броня держится ##2 секунды##, вы лечитесь на число равное ##1%## вашей максимальной брони ##каждые 0.75 секунд##, пока у вас есть броня.\n\nВы получаете на ##10%## больше брони.",
	["menu_deck_kmerc_9"] = "Сильная сторона",
	["menu_deck_kmerc_9_desc"] = "Когда становится тяжело, время переключаться на сильную сторону.\n\nКогда вы получаете урон, который оставит вас с меньше чем ##50%## здоровья, вы ##восстанавливаете броню## на число, равное полученному урону.\nНе может сработать одновременно с неуязвимостью от перка 'Отстранись'.",
	})
end)