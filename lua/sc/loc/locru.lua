...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--CUSTOM SMGs
			--LWRC
			["bm_w_smg45"] = "Пистолет-пулемет Striker .45",
			["bm_w_smg45_desc"] = "Американский клон ПП \"Jackal\".",
			--Typhoon
		...
		["bm_wp_mg42_b_vg38"] = "Насадка BlasTech DLT-19",
