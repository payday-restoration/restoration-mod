...
Hooks:PostHook( WeaponTweakData, "init", "SC_weapons", function(self)
	...
	lock_em_up = {'s552','new_m14','hajk','arbiter','ching','siltstone','new_m4','m16','amcar','tecci','tti','olympic','contraband','fal','scar','m249','par','m60'}
	for i, wep_id in ipairs(lock_em_up) do
		self[ wep_id ].lock_slide = true
	...
	recat = { "winchester1874", "qbu88", "msr", "r700", "tti" }
	for i, wep_id in ipairs(recat) do
	...
	--[[     LIGHT PISTOLS     ]]
		...
		--PRIMARIES
			...
			--Akimbo Geck M2 (Maxim 9)
				...
				self.x_maxim9.ads_speed = 0.120 * 1.5
			...
			--Akimbo Igor (APS)
				...
				self.x_stech.ads_speed = 0.100 * 1.5
			...
			--Akimbo Stryk18c
				...
				self.x_g18c.ads_speed = 0.100 * 1.5
			...
			--Akimbo CZ 75
				...
				self.x_czech.ads_speed = 0.100 * 1.5
			...
			--Akimbo Chimano .88
				...
				self.x_g17.ads_speed = 0.100 * 1.5
			...
			--Akimbo Bernetti 9
				...
				self.x_b92fs.ads_speed = 0.100 * 1.5
			...
			--Akimbo Holt 9mm
				...
				self.x_holt.ads_speed = 0.100 * 1.5
			...
			--Akimbo Contractor Pistols
				...
				self.x_packrat.ads_speed = 0.100 * 1.5
			...
			--Akimbo Model 54--
				...
				self.x_type54.ads_speed = 0.120 * 1.5
			...
			--Akimbo Model 54 Underbarrel
				...
				self.x_type54_underbarrel.ads_speed = 0.120 * 1.5
			...
			--Akimbo Chimano Custom
				...
				self.x_g22c.ads_speed = 0.120 * 1.5
	...
	--[[     HEAVY PISTOLS     ]]
		...
		--PRIMARIES
			...
			--Akimbo Crosskill Guard
				...
				self.x_shrew.ads_speed = 0.080 * 1.5
			...
			--Akimbo Interceptor .45
				...
				self.x_usp.ads_speed = 0.150 * 1.5
			...
			--Akimbo Crosskill
				...
				self.x_1911.ads_speed = 0.120 * 1.5
			...
			--Akimbo Model 87
				...
				self.x_model3.ads_speed = 0.230 * 1.5
			...
			--Akimbo Deagle
				...
				self.x_deagle.ads_speed = 0.300 * 1.5
			...
			--Akimbo Broncos
				...
				self.x_rage.ads_speed = 0.250 * 1.5
			...
			--Akimbo Matever
				...
				self.x_2006m.ads_speed = 0.200 * 1.5
			...
			--Akimbo Castigo
				...
				self.x_chinchilla.ads_speed = 0.250 * 1.5
	...
	--[[     HEAVY SHOTGUNS     ]]
		...
		--PRIMARIES
			...
			--Akimbo Judge
				...
				self.x_judge.ads_speed = 0.300 * 1.5
	...
	--[[     LIGHT SMGs     ]]
		...
		--PRIMARIES
			...
			--Akimbo Micro-Uzi
				...
				self.x_baka.ads_speed = 0.175 * 1.5
			...
			--Akimbo Heather
				...
				self.x_sr2.ads_speed = 0.250 * 1.5
			...
			--Akimbo MP5
				...
				self.x_mp5.ads_speed = 0.250 * 1.5
	...
	--[[     HEAVY SMGs     ]]
		...
		--PRIMARIES
			...
			--Akimbo MAC-10
				...
				self.x_mac10.ads_speed = 0.210 * 1.5
	...
	--[[     HEAVY ARs     ]]
		...
		--PRIMARIES
			...
			--Akimbo Krinkov
				...
				self.x_akmsu.ads_speed = 0.300 * 1.5
	...
	--[[     LIGHT SNIPERS     ]]	
		...
		--Repeater 1874
			...
			self.winchester1874.ads_speed = 0.225
		...
		--Kang Arms X1 (QBU-88)
			...
			self.qbu88.fire_mode_data.fire_rate = 0.5
		...
		--Contractor .308
			...
			self.tti.kick = self.stat_info.kick_tables.moderate_kick
	...
	--[[     HEAVY SNIPERS     ]]
		...
		--Grom (SVD)
			...
			self.siltstone.ads_speed = 0.475
	...
	--Plainsrider bow.
		...
		self.plainsrider.ads_speed = 0.150
