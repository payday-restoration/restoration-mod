...
function PlayerDamage:init(unit)
	...
	managers.hud:add_skill("aggressive_reload")
	managers.hud:add_skill("ammo_efficiency")
	managers.hud:add_skill("bloodthirst")
	managers.hud:add_skill("bullet_storm")
	managers.hud:add_skill("desperado")
	managers.hud:add_skill("grinder")
	managers.hud:add_skill("infiltrator")
	managers.hud:add_skill("inspire")
	managers.hud:add_skill("messiah")
	managers.hud:add_skill("overkill")
	managers.hud:add_skill("quick_fix")
	managers.hud:add_skill("rogue")
	managers.hud:add_skill("trigger_happy")
	managers.hud:add_skill("unseen_strike")
