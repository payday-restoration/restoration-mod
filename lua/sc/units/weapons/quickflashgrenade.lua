...
--Doing flashbang line here so hopefully it won't have the player complain about flashbangs when hit by explosive grenades
function QuickFlashGrenade:make_flash(detonate_pos, range, ignore_units)
	...
	if affected then
		...
		PlayerStandard.say_line(managers.player:player_unit():sound(), "g41x_any")
	end
end
