if not tweak_data then return end
	...
	if SC and SC._data.sc_player_weapon_toggle or restoration and restoration.Options:GetValue("SC/SCWeapon") then
		...
		if SystemFS:exists("assets/mod_overrides/Scorpion Evo/main.xml") or SystemFS:exists("assets/mod_overrides/Owen Gun/main.xml") or SystemFS:exists("assets/mod_overrides/Thompson M1A1/main.xml") or SystemFS:exists("assets/mod_overrides/CBJ-MS/main.xml") then
